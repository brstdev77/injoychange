...
$highlight_tag1 = Yii::$app->request->get('PilotLeadershipCategorySearch');
if ($highlight_tag1 != '') {
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                $countcorner = backend\models\PilotLeadershipCorner::getRecords($model->id);
                                if ($countcorner < 15) {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-leadership-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a><span title="Upload 15 Corners"style="color:red">pending</span>';
                                } else {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-leadership-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a>';
                                }
                            },
                        ],
                        //'user_id',
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                return backend\models\PilotLeadershipCategory::getUpdated($model->id, $model->user_id);
                            },
                        ],
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    ...
                                    if (!(in_array($model->id, $leadership_corner))):
                                        return "<a data-method='post' data-confirm='Are you sure you want to delete this item?'class=' grid btn btn-default' href='" . Yii::$app->homeUrl . "pilot-leadership-category/delete?id=" . $model->id . "'><i class='fa fa-trash-o'></i>&nbsp;Delete</a>";
                                    else:

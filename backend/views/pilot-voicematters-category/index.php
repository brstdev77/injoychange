...
/* @var $searchModel backend\models\PilotActionmattersCategorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$highlight_tag1 = Yii::$app->request->get('PilotActionmattersCategorySearch');
if ($highlight_tag1 != '') {
    $highlight_tag = $highlight_tag1['tag_id'];
}
$this->title = 'Voice Matters Categories';
...
$tags_name = [];
?>
<div class="pilot-weekly-category-index">
    ...
    <div class="grid_weekly_category grid_verical">
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Voice Matters</h3>
...
//                    ],
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                $countvideo = backend\models\PilotActionmattersChallenge::getRecords($model->id);
                                if ($countvideo < 4) {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countvideo . ' Questions&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-voicematters-challenge/index?cid=' . $model->id . '" class="btn btn-default">Manage</a><span title="Upload 6 Videos"style="color:red">pending</span>';
                                } else {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countvideo . ' Questions&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-voicematters-challenge/index?cid=' . $model->id . '" class="btn btn-default">Manage</a>';
                                }
                            },
                        ],
                        // 'user_id',
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                return backend\models\PilotActionmattersCategory::getUpdated($model->id, $model->user_id);
                            },
                        ],
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    ...
                                    foreach ($game_obj as $game):
                                        $weekly_challenge[] = $game->weekly_challenge_content;
                                    endforeach;
                                    if (!(in_array($model->id, $weekly_challenge))):
                                        return "<a data-method='post' data-confirm='Are you sure you want to delete this item?'class=' grid btn btn-default' href='" . Yii::$app->homeUrl . "pilot-voicematters-category/delete?id=" . $model->id . "'><i class='fa fa-trash-o'></i>&nbsp;Delete</a>";
                                    else:
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <?= Html::submitButton('Submit', ['class' => 'btn btn-success' ,'id' => 'voicecategory-submit']) ?>

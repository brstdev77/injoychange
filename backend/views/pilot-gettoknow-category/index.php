...
$highlight_tag1 = Yii::$app->request->get('PilotGettoknowCategorySearch');
if ($highlight_tag1 != '') {
    $highlight_tag = $highlight_tag1['tag_id'];
}
$this->title = 'Pilot GetToKnow Categories';
...
$tags_name = [];
?>
<div class="pilot-gettoknow-category-index">
    ...
    <div class="grid_weekly_category grid_verical">
        <div class="box box-warning">
            <div class="box-header">
                ...
                <?= Html::a('Add New Category <i class="fa fa-plus"></i>', ['javascript:void(0)'], ['class' => 'btn btn-default pull-right', 'data-toggle' => 'modal', 'data-target' => '#add_gettoknow_category']) ?>
            </div>
            ...
            <?php if (PilotInhouseUser::isUserAdmin(Yii::$app->user->identity->id)): ?>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'label' => 'GetToKnow Corner',
                            'attribute' => 'weekly_challenge',
                            'format' => 'html',
                            'value' => function ($model) {
                                $countcorner = backend\models\PilotGettoknowCorner::getRecords($model->id);
                                if ($countcorner < 15) {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-gettoknow-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a><span title="Upload 15 Corners"style="color:red">pending</span>';
                                } else {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-gettoknow-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a>';
                                }
                            },
                        ],
                        //'user_id',
                        ...
                        ['class' => 'yii\grid\ActionColumn',
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                        return "<a data-method='post' data-confirm='Are you sure you want to delete this item?'class=' grid btn btn-default' href='" . Yii::$app->homeUrl . "pilot-gettoknow-category/delete?id=" . $model->id . "'><i class='fa fa-trash-o'></i>&nbsp;Delete</a>";
...
<div class="container">
    <div class="modal fade" id="add_gettoknow_category" role="dialog" data-backdrop="static" data-keyboard="false">

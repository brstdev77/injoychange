...
<header class="main-header">
    ...
    <a href="<?php echo $baseUrl; ?>" class="logo">
      ...
      <span class="logo-mini"><b>A</b>LT</span>      <!-- logo for regular state and mobile devices -->     <!-- <span class="logo-lg"><b>Admin</b>LTE</span>-->	  
        <div><img style="width:60px;background:white;" src="http://root.injoychange.com/backend/web/image/Titlelogo.png"></div>
    </a>
    <!-- Header Navbar -->    
    <nav class="navbar navbar-static-top" role="navigation">
        <!-- Sidebar toggle button-->      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">      
            <span class="sr-only">Toggle navigation</span>      </a>      <!-- Navbar Right Menu -->      
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <?php if(!empty(Yii::$app->user->identity->profile_pic)) { ?>                        
                        <img src=<?php echo $baseUrl . "/img/profilepic/".Yii::$app->user->identity->profile_pic; ?> class="user-image" alt="User Image">  
                         <?php } else {?>
                         <img src=<?php echo $baseUrl .  "/img/profilepic/noimage.png" ?> class="user-image" alt="User Image">  
                          <?php  } ?>
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->			
<?php if (Yii::$app->user->identity) { ?>              <span class="hidden-xs"><?php echo Yii::$app->user->identity->username; ?></span>		
<?php } ?>            
                    </a>
                   <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">                 
                                <a href=<?php echo $baseUrl . "site/logout" ?> class="btn btn-default btn-flat">logout</a>          
                            </div>
                        </li>
                    </ul>
                </li>

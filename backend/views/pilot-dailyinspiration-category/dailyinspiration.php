...
<?php
$model = PilotDailyinspirationImage::find()->where(['category_id' => Yii::$app->request->get('cid')])->orderBy([new \yii\db\Expression('order_number')])->all();

$category = PilotDailyinspirationCategory::find()->where(['id' => Yii::$app->request->get('cid')])->one();
?>
                        ...
                        if ($model) {
                            ...
                            <div class='grid-item'>
                                <?php foreach ($model as $val) { ?>
									...
									<a class="delete1" rel="<?php echo $val->id ?>" cid="<?php echo $val->category_id ?>">
									<i class="fa fa-trash-o img_delete"></i></a>
									<p class="img_delete1">Day <?= $val->order_number ?></p>
									<img rel='<?php echo $val->order_number ?>' style='max-width:240px;'src="<?php echo Yii::$app->homeUrl ?>img/daily-inspiration-images/<?php echo $val->image_name ?>"></div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Image ( image name will be like this "1.jpg" or "2.jpg" etc.)</h4>
                </div>
                <div class="modal-body">
                    <form action="dailyinspiration"  class="custom_dropzone" id="my-awesome-dropzone">
                        ...
                        <input type='hidden' value='<?php echo Yii::$app->request->get('cid'); ?>' name='category_id' class='category_id'>
                    </form>
                ...
                <div class="modal-footer">
                    <button id='popup_submit' type="button" class="btn btn-success" >Submit</button>

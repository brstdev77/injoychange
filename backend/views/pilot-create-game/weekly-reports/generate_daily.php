...
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A7', 'Daily Inspiration Report');
...
$objPHPExcel->getActiveSheet()->getStyle('A7:K8')->getFont()->setSize(18);
$objPHPExcel->getActiveSheet()->getStyle('A7:K7')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A8:K8')->applyFromArray($style_bold);
...
$objPHPExcel->getActiveSheet()->setTitle('Daily Inspiration');

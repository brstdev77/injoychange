...
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A7', 'Voice Matters Report');
...
foreach ($data as $data_name):
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H9', $data_name[2]);
     $objPHPExcel->getActiveSheet()->mergeCells('J9:O9');
...
foreach ($dataxls as $data):
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('J' . $i, strip_tags(preg_replace("/&#?[a-z0-9]{2,8};/i"," ",$string)));
...
$objPHPExcel->getActiveSheet()->setTitle('Voice Matters');

// Set active sheet index to the first sheet, so Excel opens this as the first sheet
$objPHPExcel->setActiveSheetIndex(0);

//Report Name
$file_name = 'voicematters.xls';

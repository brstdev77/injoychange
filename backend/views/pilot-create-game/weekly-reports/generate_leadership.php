...
$objPHPExcel->getActiveSheet()->mergeCells('A1:M4');
/* ADD LOGO */
...
/* END LOGO */
$objPHPExcel->getActiveSheet()->mergeCells('A5:M6');
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A5', ucwords($challenge_name));
//Merge Cells for Challenge Name
$objPHPExcel->getActiveSheet()->mergeCells('A7:M8');
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A7', 'Leadership Corner Report');
...
$objPHPExcel->getActiveSheet()->setTitle('Leadership Corner');

// Set active sheet index to the first sheet, so Excel opens this as the first sheet
$objPHPExcel->setActiveSheetIndex(0);

//Report Name
$file_name = 'leadership.xls';

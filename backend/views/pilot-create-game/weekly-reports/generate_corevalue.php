...
$objPHPExcel->getActiveSheet()->mergeCells('A1:O4');
/* ADD LOGO */
...
/* END LOGO */
$objPHPExcel->getActiveSheet()->mergeCells('A5:O6');
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A5', ucwords($challenge_name));
//Merge Cells for Challenge Name
$objPHPExcel->getActiveSheet()->mergeCells('A7:O8');
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A7', 'Core Value Report');
...
foreach ($data as $data_name):
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('D9', $data_name[1]);
    $objPHPExcel->getActiveSheet()->mergeCells('F9:G9');
    $objPHPExcel->getActiveSheet()->setCellValue('F9', $data_name[2]);
    $objPHPExcel->getActiveSheet()->mergeCells('H9:I9');
    $objPHPExcel->getActiveSheet()->setCellValue('H9', $data_name[3]);
    $objPHPExcel->getActiveSheet()->mergeCells('J9:K9');
    $objPHPExcel->getActiveSheet()->setCellValue('J9', $data_name[4]);
    $objPHPExcel->getActiveSheet()->mergeCells('L9:O9');
    $objPHPExcel->getActiveSheet()->setCellValue('L9', $data_name[5]);
...
foreach ($dataxls as $data):
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $data['emailaddress']);
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $i, $data['time']);
    $objPHPExcel->getActiveSheet()->mergeCells('J'.$i.':K'.$i);
    $objPHPExcel->getActiveSheet()->setCellValue('J' . $i, $data['label']);
...
//Bold Text & Font Size
$objPHPExcel->getActiveSheet()->getStyle('A5:O6')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A5:O6')->getFont()->setSize(18);
$objPHPExcel->getActiveSheet()->getStyle('A7:O8')->getFont()->setSize(18);
$objPHPExcel->getActiveSheet()->getStyle('A7:O7')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A8:O8')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A9:O9')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A9:O9')->getFont()->setSize(12);
//Border
$lastcell = $i - 1;
$objPHPExcel->getActiveSheet()->getStyle('A1:O' . $lastcell)->applyFromArray($style_border);
...
$objPHPExcel->getActiveSheet()->setTitle('Core Value');

// Set active sheet index to the first sheet, so Excel opens this as the first sheet
$objPHPExcel->setActiveSheetIndex(0);

//Report Name
$file_name = 'corevalue.xls';

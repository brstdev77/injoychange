...
//Challenge Name Display
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'Registered User');

foreach ($data as $data_name):
    $objPHPExcel->getActiveSheet()->setCellValue('A3', 'S.No.');
    $objPHPExcel->getActiveSheet()->mergeCells('B3:D3');
    $objPHPExcel->getActiveSheet()->setCellValue('B3', $data_name[0]);
    $objPHPExcel->getActiveSheet()->mergeCells('E3:G3');
    $objPHPExcel->getActiveSheet()->setCellValue('E3', $data_name[1]);
...
//Bold Text & Font Size
$objPHPExcel->getActiveSheet()->getStyle('A1:G2')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A1:G2')->getFont()->setSize(18);
$objPHPExcel->getActiveSheet()->getStyle('A1:G2')->getFont()->setSize(18);
$objPHPExcel->getActiveSheet()->getStyle('A1:G1')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A2:G2')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A3:G3')->applyFromArray($style_bold);
$objPHPExcel->getActiveSheet()->getStyle('A3:G3')->getFont()->setSize(12);
//Border
$lastcell = $i - 1;
$objPHPExcel->getActiveSheet()->getStyle('A1:G' . $lastcell)->applyFromArray($style_border);

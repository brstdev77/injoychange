...
$highlight_tag1 = Yii::$app->request->get('PilotWeeklyCategorySearch');
if ($highlight_tag1 != '') {
    $highlight_tag = $highlight_tag1['tag_id'];
}
$this->title = 'Weekly Categories';
...
//                    ],
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                $countvideo = backend\models\PilotWeeklyChallenge::getRecords($model->id);
                                if ($countvideo < 6) {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countvideo . ' Video&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-weekly-challenge/index?cid=' . $model->id . '" class="btn btn-default">Manage</a><span title="Upload 6 Videos"style="color:red">pending</span>';
                                } else {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countvideo . ' Video&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-weekly-challenge/index?cid=' . $model->id . '" class="btn btn-default">Manage</a>';
                                }
                            },
                        ],
                        // 'user_id',
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                return backend\models\PilotWeeklyCategory::getUpdated($model->id, $model->user_id);
                            },
                        ],
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    ...
                                    if (!(in_array($model->id, $weekly_challenge))):
                                        return "<a data-method='post' data-confirm='Are you sure you want to delete this item?'class=' grid btn btn-default' href='" . Yii::$app->homeUrl . "pilot-weekly-category/delete?id=" . $model->id . "'><i class='fa fa-trash-o'></i>&nbsp;Delete</a>";
                                    else:

...
/* @var $searchModel backend\models\PilotTodayslessonCategorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$highlight_tag1 = Yii::$app->request->get('PilotTodayslessonCategorySearch');
if ($highlight_tag1 != '') {
    $highlight_tag = $highlight_tag1['tag_id'];
}
$this->title = 'Pilot Today Lesson Categories';
...
$tags_name = [];
?>
<div class="pilot-Todayslesson-category-index">
    ...
    <div class="grid_weekly_category grid_verical">
        <div class="box box-warning">
            <div class="box-header">
                ...
                <?= Html::a('Add New Category <i class="fa fa-plus"></i>', ['javascript:void(0)'], ['class' => 'btn btn-default pull-right', 'data-toggle' => 'modal', 'data-target' => '#add_leadership_category']) ?>
            </div>
            ...
            <?php if (PilotInhouseUser::isUserAdmin(Yii::$app->user->identity->id)): ?>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'label' => "Today's Lesson Corner",
                            'attribute' => 'weekly_challenge',
                            'format' => 'html',
                            'value' => function ($model) {
                                $countcorner = backend\models\PilotTodayslessonCorner::getRecords($model->id);
                                if ($countcorner < 15) {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-todayslesson-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a><span title="Upload 15 Corners"style="color:red">pending</span>';
                                } else {
                                    return '<i class="fa fa-paste"></i>&nbsp;&nbsp;' . $countcorner . ' Corner&nbsp;&nbsp;<a href="' . Yii::$app->homeUrl . 'pilot-todayslesson-corner/index?cid=' . $model->id . '" class="btn btn-default">Manage</a>';
                                }
                            },
                        ],
                        //'user_id',
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                return backend\models\PilotTodayslessonCategory::getUpdated($model->id, $model->user_id);
                            },
                        ],
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    ...
                                    if (!(in_array($model->id, $leadership_corner))):
                                        return "<a data-method='post' data-confirm='Are you sure you want to delete this item?'class=' grid btn btn-default' href='" . Yii::$app->homeUrl . "pilot-todayslesson-category/delete?id=" . $model->id . "'><i class='fa fa-trash-o'></i>&nbsp;Delete</a>";
                                    else:
...
<div class="container">
    <div class="modal fade" id="add_leadership_category" role="dialog" data-backdrop="static" data-keyboard="false">

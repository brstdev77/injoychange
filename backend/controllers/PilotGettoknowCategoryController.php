...
use backend\models\PilotGettoknowCategorySearch;
 ...
 */
class PilotGettoknowCategoryController extends Controller {
    ...
    public function actionIndex() {
        $searchModel = new PilotGettoknowCategorySearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $model = new PilotGettoknowCategory();
    ...
    public function actionDelete($id) {
        ...
        $model = PilotGettoknowCorner::find()->where(['category_id' => $id])->all();
            ...
            \Yii::$app->db->createCommand()->delete('pilot_gettoknow_corner', ['category_id' => $id])->execute();
    ...
    protected function findModel($id) {
        if (($model = PilotGettoknowCategory::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionLoadTag() {
        ...
        $model = new PilotGettoknowCategory;
        $model1 = new Pilottags;
        $modal = PilotGettoknowCategory::find()->where(['id' => $id])->one();
        if (!empty($modal)):
        ...
        if (Yii::$app->request->post()) {
            $id = Yii::$app->request->post()['PilotGettoknowCategory']['id'];
            ...
            endforeach;
            if ($modal->category_name != Yii::$app->request->post()['PilotGettoknowCategory']['category_name']):
                $modal->category_name = Yii::$app->request->post()['PilotGettoknowCategory']['category_name'];
            endif;

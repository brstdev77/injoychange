...
/**
 * PilotCheckinYourselfCategorySearch represents the model behind the search form about `backend\models\PilotCheckinYourselfCategory`.
 */
class PilotCheckinYourselfCategorySearch extends PilotCheckinYourselfCategory {
...
// bypass scenarios() implementation in the parent class
    ...
    public function search($params) {
        $query = PilotCheckinYourselfCategory::find()->orderBy(['created' => SORT_DESC]);

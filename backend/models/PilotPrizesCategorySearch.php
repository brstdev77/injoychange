...
/**
 * PilotPrizesCategorySearch represents the model behind the search form about `backend\models\PilotPrizesCategory`.
 */
class PilotPrizesCategorySearch extends PilotPrizesCategory {
    ...
    public function search($params) {
        $query = PilotPrizesCategory::find();

...
/**
 * PilotDailyinspirationCategorySearch represents the model behind the search form about `backend\models\PilotDailyinspirationCategory`.
 */
class PilotCoreValuesImageCategorySearch extends PilotCoreValuesImageCategory {
    ...
    public function search($params) {
        $query = PilotCoreValuesImageCategory::find();

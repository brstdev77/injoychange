...
/**
 * PilotActionmattersCategorySearch represents the model behind the search form about `backend\models\PilotActionmattersCategory`.
 */
class PilotActionmattersCategorySearch extends PilotActionmattersCategory
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PilotActionmattersCategory::find();

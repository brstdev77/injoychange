...
/**
 * PilotLeadershipCategorySearch represents the model behind the search form about `backend\models\PilotLeadershipCategory`.
 */
class PilotTodayslessonCategorySearch extends PilotTodayslessonCategory
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PilotTodayslessonCategory::find();

...
/**
 * PilotFrontPeakCheckinSearch represents the model behind the search form about `frontend\models\PilotFrontPeakCheckin`.
 */
class PilotFrontPeakCheckinSearch extends PilotFrontPeakCheckin {
  ...
  public function search($params) {
    $query = PilotFrontPeakCheckin::find();

...
/**
 * This is the model class for table "pilot_front_peak_shareawin".
 *
 * @property integer $id
 ...
 */
class PilotFrontPeakShareawin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_peak_shareawin';
  }

...
/**
 * This is the model class for table "pilot_front_productivity_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_productivity_notifications';
    }

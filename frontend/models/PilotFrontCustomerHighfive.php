...
/**
 * This is the model class for table "pilot_front_customerce_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontCustomerHighfive extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_customer_highfive';
  }

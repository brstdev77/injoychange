...
/**
 * PilotFrontProductivityShareawinSearch represents the model behind the search form about `frontend\models\PilotFrontProductivityShareawin`.
 */
class PilotFrontProductivityShareawinSearch extends PilotFrontProductivityShareawin {
  ...
  public function search($params) {
    $query = PilotFrontProductivityShareawin::find();

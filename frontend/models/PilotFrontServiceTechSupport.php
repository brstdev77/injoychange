...
/**
 * This is the model class for table "pilot_front_service_tech_support".
 *
 ...
 */
class PilotFrontServiceTechSupport extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_service_tech_support';
  }

...
/**
 * This is the model class for table "pilot_front_peak_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontPeakSurveyData extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_peak_survey_data';
  }
  ...
  public function rules() {
    return [
      [['challenge_id', 'user_id', 'survey_response', 'dayset', 'created', 'updated'], 'required'],
      [['challenge_id', 'user_id', 'survey_question_id', 'week_no', 'created', 'updated'], 'integer'],
      [['survey_filled', 'permission_use_data', 'dayset'], 'string', 'max' => 255],
      [['survey_response'], 'string', 'max' => 4000],
    ];
  }

...
/**
 * This is the model class for table "pilot_front_productivity_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityHighfive extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'pilot_front_productivity_highfive';
    }
    ...
    public function rules() {
        return [
            [['game_id', 'user_id', 'company_id', 'team_id', 'feature_label', 'feature_value', 'points', 'created', 'updated'], 'required'],

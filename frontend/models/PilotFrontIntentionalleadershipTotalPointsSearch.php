...
/**
 * PilotFrontServiceTotalPointsSearch represents the model behind the search form about `frontend\models\PilotFrontServiceTotalPoints`.
 */
class PilotFrontIntentionalleadershipTotalPointsSearch extends PilotFrontIntentionalleadershipTotalPoints {
    ...
    public function search($params) {
        $query = PilotFrontIntentionalleadershipTotalPoints::find();
    ...
    public function searchbackend($params, $id) {
        ...
        $query = $model_scorepoints::find()->where(['game_id' => $challid, 'pilot_front_intentionalleadership_total_points.company_id' => $cid])
                ->andWhere(['between', 'pilot_front_intentionalleadership_total_points.created',  $gamemodel->challenge_start_date,  $gamemodel->challenge_end_date])

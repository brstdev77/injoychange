...
/**
 * This is the model class for table "pilot_front_core_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontCoreSurveyData extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_core_survey_data';
  }

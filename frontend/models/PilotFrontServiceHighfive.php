...
/**
 * This is the model class for table "pilot_front_service_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontServiceHighfive extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_service_highfive';
  }

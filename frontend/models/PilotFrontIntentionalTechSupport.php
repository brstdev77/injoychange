...
/**
 * This is the model class for table "pilot_front_intentional_tech_support".
 *
 ...
 */
class PilotFrontIntentionalTechSupport extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_intentional_tech_support';
  }

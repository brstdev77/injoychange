 ...
 */
class PilotFrontServiceTotalPointsSearch extends PilotFrontServiceTotalPoints {
    ...
    public function search($params) {
        $query = PilotFrontServiceTotalPoints::find();
    ...
    public function searchbackend($params, $id) {
        ...
        $query = $model_scorepoints::find()->where(['game_id' => $challid, 'pilot_front_service_total_points.company_id' => $cid])
                ->andWhere(['between', 'pilot_front_service_total_points.created',  $gamemodel->challenge_start_date,  $gamemodel->challenge_end_date])

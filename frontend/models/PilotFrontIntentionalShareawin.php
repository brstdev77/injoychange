...
/**
 * This is the model class for table "pilot_front_intentional_shareawin".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalShareawin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_intentional_shareawin';
  }

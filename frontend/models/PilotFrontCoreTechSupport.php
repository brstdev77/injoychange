...
/**
 * This is the model class for table "pilot_front_core_tech_support".
 *
 ...
 */
class PilotFrontCoreTechSupport extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_core_tech_support';
  }

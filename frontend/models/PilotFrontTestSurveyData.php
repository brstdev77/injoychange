...
/**
 * This is the model class for table "pilot_front_test_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontTestSurveyData extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_test_survey_data';
    }

...
/**
 * This is the model class for table "pilot_front_productivity_steps_modal".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityStepsModal extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_productivity_steps_modal';
    }

...
/**
 * PilotFrontCustomerNotificationsSearch represents the model behind the search form about `frontend\models\PilotFrontCustomerNotifications`.
 */
class PilotFrontCustomerNotificationsSearch extends PilotFrontCustomerNotifications
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PilotFrontCustomerNotifications::find();

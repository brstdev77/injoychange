...
/**
 * PilotFrontLeadershipTotalPointsSearch represents the model behind the search form about `frontend\models\PilotFrontLeadershipTotalPoints`.
 */
class PilotFrontLeadershipTotalPointsSearch extends PilotFrontLeadershipTotalPoints {
    ...
    public function search($params) {
        $query = PilotFrontLeadershipTotalPoints::find();
    ...
    public function searchbackend($params, $id) {
        ...
        $query = $model_scorepoints::find()->where(['game_id' => $challid, 'pilot_front_leadership_total_points.company_id' => $cid])
                ->andWhere(['between', 'pilot_front_leadership_total_points.created',  $gamemodel->challenge_start_date,  $gamemodel->challenge_end_date])

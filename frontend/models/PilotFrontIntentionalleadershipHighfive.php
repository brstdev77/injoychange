...
/**
 * This is the model class for table "pilot_front_intentionalleadershipce_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalleadershipHighfive extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_intentionalleadership_highfive';
  }

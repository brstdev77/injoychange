...
/**
 * PilotFrontIntentionalleadershipNotificationsSearch represents the model behind the search form about `frontend\models\PilotFrontIntentionalleadershipNotifications`.
 */
class PilotFrontIntentionalleadershipNotificationsSearch extends PilotFrontIntentionalleadershipNotifications
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PilotFrontIntentionalleadershipNotifications::find();

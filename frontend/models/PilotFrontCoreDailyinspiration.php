...
/**
 * This is the model class for table "pilot_front_core_dailyinspiration".
 *
 * @property integer $id
 ...
 */
class PilotFrontCoreDailyinspiration extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_core_dailyinspiration';
  }

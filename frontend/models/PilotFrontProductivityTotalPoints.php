...
/**
 * This is the model class for table "pilot_front_productivity_total_points".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityTotalPoints extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'pilot_front_productivity_total_points';
    }

...
/**
 * This is the model class for table "pilot_front_peak_tech_support".
 *
 ...
 */
class PilotFrontPeakTechSupport extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_peak_tech_support';
  }

...
/**
 * This is the model class for table "pilot_front_productivity_rating".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityRating extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_productivity_rating';
    }

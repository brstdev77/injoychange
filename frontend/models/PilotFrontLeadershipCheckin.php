...
/**
 * This is the model class for table "pilot_front_leadership_checkin".
 *
 * @property integer $id
 ...
 */
class PilotFrontLeadershipCheckin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_leadership_checkin';
  }

...
/**
 * This is the model class for table "pilot_front_leadership_total_points".
 *
 * @property integer $id
 ...
 */
class PilotFrontLeadershipTotalPoints extends \yii\db\ActiveRecord
{
    public $username;
    public $emailaddress;
    /**
    ...
    {
        return 'pilot_front_leadership_total_points';
    }

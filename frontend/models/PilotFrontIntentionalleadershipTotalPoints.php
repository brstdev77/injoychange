...
/**
 * This is the model class for table "pilot_front_service_total_points".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalleadershipTotalPoints extends \yii\db\ActiveRecord
{
    public $username;
    public $emailaddress;
    /**
    ...
    {
        return 'pilot_front_intentionalleadership_total_points';
    }
    ...
    {
        return [
            [['game_id', 'user_id', 'company_id', 'total_points', 'total_core_values', 'total_raffle_entry', 'total_game_actions', 'created', 'updated'], 'required'],

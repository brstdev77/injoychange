...
/**
 * This is the model class for table "pilot_front_service_checkin".
 *
 * @property integer $id
 ...
 */
class PilotFrontServiceCheckin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_service_checkin';
  }

...
/**
 * PilotFrontCoreCheckinSearch represents the model behind the search form about `frontend\models\PilotFrontCoreCheckin`.
 */
class PilotFrontIntentionalCheckinSearch extends PilotFrontCoreCheckin {
  ...
  public function search($params) {
    $query = PilotFrontIntentionalCheckin::find();

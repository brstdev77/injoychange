...
/**
 * This is the model class for table "pilot_front_intentional_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalHighfive extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_intentional_highfive';
  }

...
/**
 * This is the model class for table "pilot_front_core_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontCoreNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_core_notifications';
    }

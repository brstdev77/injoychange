...
/**
 * This is the model class for table "pilot_front_service_rating".
 *
 * @property integer $id
 ...
 */
class PilotFrontServiceRating extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_service_rating';
    }

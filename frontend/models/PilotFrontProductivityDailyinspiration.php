...
/**
 * This is the model class for table "pilot_front_productivity_dailyinspiration".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityDailyinspiration extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_productivity_dailyinspiration';
    }

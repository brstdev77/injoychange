...
/**
 * This is the model class for table "pilot_front_service_shareawin".
 *
 * @property integer $id
 ...
 */
class PilotFrontServiceShareawin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_service_shareawin';
  }

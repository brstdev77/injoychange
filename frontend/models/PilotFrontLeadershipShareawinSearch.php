...
/**
 * PilotFrontLeadershipShareawinSearch represents the model behind the search form about `frontend\models\PilotFrontLeadershipShareawin`.
 */
class PilotFrontLeadershipShareawinSearch extends PilotFrontLeadershipShareawin {
  ...
  public function search($params) {
    $query = PilotFrontLeadershipShareawin::find();

...
/**
 * This is the model class for table "pilot_front_productivity_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivitySurveyData extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_productivity_survey_data';
    }
    ...
    {
        return [
            [['challenge_id', 'user_id', 'dayset', 'created', 'updated'], 'required'],

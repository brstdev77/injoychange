...
/**
 * This is the model class for table "pilot_front_service_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalleadershipNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_intentionalleadership_notifications';
    }

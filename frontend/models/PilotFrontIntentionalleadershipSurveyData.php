...
/**
 * This is the model class for table "pilot_front_intentionalleadership_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalleadershipSurveyData extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_intentionalleadership_survey_data';
    }

...
/**
 * This is the model class for table "pilot_front_leadership_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontLeadershipNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_leadership_notifications';
    }

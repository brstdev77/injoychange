...
/**
 * This is the model class for table "pilot_front_peak_dailyinspiration".
 *
 * @property integer $id
 ...
 */
class PilotFrontPeakDailyinspiration extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_peak_dailyinspiration';
  }

...
/**
 * PilotFrontPeakShareawinSearch represents the model behind the search form about `frontend\models\PilotFrontPeakShareawin`.
 */
class PilotFrontPeakShareawinSearch extends PilotFrontPeakShareawin {
  ...
  public function search($params) {
    $query = PilotFrontPeakShareawin::find();

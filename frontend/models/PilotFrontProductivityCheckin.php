...
/**
 * This is the model class for table "pilot_front_productivity_checkin".
 *
 * @property integer $id
 ...
 */
class PilotFrontProductivityCheckin extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'pilot_front_productivity_checkin';
    }

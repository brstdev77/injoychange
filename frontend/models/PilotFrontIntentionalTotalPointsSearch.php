...
/**
 * PilotFrontCoreTotalPointsSearch represents the model behind the search form about `frontend\models\PilotFrontCoreTotalPoints`.
 */
class PilotFrontIntentionalTotalPointsSearch extends PilotFrontIntentionalTotalPoints {
    ...
    public function search($params) {
        $query = PilotFrontIntentionalTotalPoints::find();

...
/**
 * PilotFrontCoreShareawinSearch represents the model behind the search form about `frontend\models\PilotFrontCoreShareawin`.
 */
class PilotFrontIntentionalShareawinSearch extends PilotFrontIntentionalShareawin {
  ...
  public function search($params) {
    $query = PilotFrontIntentionalShareawin::find();

...
/**
 * This is the model class for table "pilot_front_intentional_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_intentional_notifications';
    }

...
/**
 * This is the model class for table "pilot_front_intentional_checkin".
 *
 * @property integer $id
 ...
 */
class PilotFrontIntentionalCheckin extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_intentional_checkin';
  }

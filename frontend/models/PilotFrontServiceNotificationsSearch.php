...
/**
 * PilotFrontServiceNotificationsSearch represents the model behind the search form about `frontend\models\PilotFrontServiceNotifications`.
 */
class PilotFrontServiceNotificationsSearch extends PilotFrontServiceNotifications
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PilotFrontServiceNotifications::find();

...
/**
 * PilotFrontLeadershipCheckinSearch represents the model behind the search form about `frontend\models\PilotFrontLeadershipCheckin`.
 */
class PilotFrontLeadershipCheckinSearch extends PilotFrontLeadershipCheckin {
  ...
  public function search($params) {
    $query = PilotFrontLeadershipCheckin::find();

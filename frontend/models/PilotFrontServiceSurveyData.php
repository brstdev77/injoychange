...
/**
 * This is the model class for table "pilot_front_service_survey_data".
 *
 * @property integer $id
 ...
 */
class PilotFrontServiceSurveyData extends \yii\db\ActiveRecord {

  /**
   * @inheritdoc
   */
  public static function tableName() {
    return 'pilot_front_service_survey_data';
  }

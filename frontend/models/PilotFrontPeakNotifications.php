...
/**
 * This is the model class for table "pilot_front_peak_notifications".
 *
 * @property integer $id
 ...
 */
class PilotFrontPeakNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pilot_front_peak_notifications';
    }

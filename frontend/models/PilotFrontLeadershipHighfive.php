...
/**
 * This is the model class for table "pilot_front_leadership_highfive".
 *
 * @property integer $id
 ...
 */
class PilotFrontLeadershipHighfive extends \yii\db\ActiveRecord {
  ...
  public static function tableName() {
    return 'pilot_front_leadership_highfive';
  }

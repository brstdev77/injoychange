...
/**
 * PilotFrontProductivityCheckinSearch represents the model behind the search form about `frontend\models\PilotFrontProductivityCheckin`.
 */
class PilotFrontProductivityCheckinSearch extends PilotFrontProductivityCheckin {
    ...
    public function search($params) {
        $query = PilotFrontProductivityCheckin::find();

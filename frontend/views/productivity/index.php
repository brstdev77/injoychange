...
$this->title = 'Landing Page | Productivity';
...
<img class=main-banner src="<?= $baseurl; ?>/images/bannerproductivity.png" alt=banner height=392 width=1180 />
</div>
</div>
</div>
...
<div class="home_page_text">
     ...
     It's time to maintain a healthy, and balanced lifestyle. That's what this challenge is all about!</div>
    <h1 class="rtecenter"><strong> Welcome to the 30 - Day Productivity Challenge!</strong></h1>
...
<ul class="">
    ...
    else
    {
        ?>
    <ul>
            <li><a href="<?= $baseurl; ?>/productivity/dashboard" class=name_user>Dashboard</a> </li>

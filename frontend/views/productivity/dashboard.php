...
$this->title = 'Dashboard | Productivity Challenge';
            ...
            <div class=col-md-12>
                <div class=main-dashboard-banner>
                    ...
                    if (!empty($active_challenge->banner_image)) {
                        ?>
                        <img class=main-banner src="<?php echo Yii::getAlias('@back_end') . '/img/game' ?>/welcome_banner/<?= $active_challenge->banner_image; ?>" alt=banner height=392 width=1180 />
                    <?php } else { ?>
                        <img class=main-banner src="<?= $baseurl; ?>/images/banner_productivity.png" alt=banner height=392 width=1180 />
                    <?php } ?>
                </div>
            </div>
        </div>
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/productivity/daily-inspiration">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
...
<!--                                    <li class=abs><img class=point src="<?= $baseurl; ?>/images/point.png" alt=point height=50 width=51><p class="core_values num_pt_circle1"></p><p class="pt hide">points</p> </li>-->
            ...
            <div class="col-md-8 col-sm-8 outer_right">
                            ...
                            <div class=form>
                                ...
                                <?php if (empty($prev_today_values_currentday)): ?>
                                    ...
                                    <div>
                                            ...
                                            <div class=form-group>
                                                <div class="form-item form-type-textarea form-item-today-values">
                                                    <div class="form-textarea-wrapper resizable textarea-processed resizable-textarea">
                                                        <?= $form->field($today_valuesModel, 'comment', ['inputOptions' => ['placeholder' => "$placeholder_text", 'class' => 'good-news-textarea form-textarea required form-textarea', 'onkeyup' => 'return max_char_length(this);']])->textarea(['id' => 'core_value_area', 'maxlength' => 100])->label(false); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class=checkin-seeall><a href="<?= $baseurl; ?>/productivity/checkin" class="">See All&nbsp;<span><i class="fa fa-angle-right"></i></span></a></div>
                                    </div>
                                    <?php ActiveForm::end(); ?>
                                <?php else: ?>
                                    <div id="today_values">
                ...
                <div class=s_shout_out>
                    <div class=bg-color>
                        <h1 class=heading_w>SHOUT OUTS & DIGITAL HIGH 5's</h1>
                        <div class=place>
                            <?php
                            $form = ActiveForm::begin([
                                        'id' => 'form-high-five',
                                ...
                                <div class="content pc">
                                    <div class=top-content>
                                        <div class=comment-container>
                                            ...
                                            <div class="benefits-textbox form-control" placeholder="What is one thing or person you appreciate today?" id=benefits-recieved contenteditable=true maxlength="100"></div>
                                        </div>
                                        <div id=display></div>
                                        <div id=msgbox></div>
                                    </div>
                            ...
                            <div class=addmore-seeall>
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/productivity/high-five">See All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                            ...
                            <div class=last-content>
                                <?php if (count($all_highfives) == 0): ?>
                                    ...
                                    foreach ($all_highfives as $hghfv):
                                        ...
                                        $check_comment_liked = PilotFrontProductivityHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                        ...
                                        $total_likes = PilotFrontProductivityHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                        //Total Comments
                                        $total_comments = PilotFrontProductivityHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                        //Time
                                        $created = $hghfv->created;
                                        $cmnt_time = date('M d, Y h:i A', $created);

                                        //Comment Image
                                        $comment_image = PilotFrontProductivityHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                        ?>
                ...
                <div class=today_g>
                    ...
                    <div class=content>
                        ...
                        <div class=submitleader>
                            ...
                            <span class="see-al"><a href="<?= $baseurl; ?>/productivity/toolbox">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=today_g>
                    ...
                    <div class=content>
                        ...
                        <div class=align-center>
                            ...
                            <span class=see-al><a href="<?= $baseurl; ?>/productivity/share-a-win">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" role="dialog" id="highfive-image-zoom" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"></button>
...
if ($show_survey == 'true'):
    ...
    ?>
    <div class="modal fade" role="dialog" id="survey" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">       
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-form">
                    ...
                    <div class = "modal-footer">
                        ...
                        <a href="javascript:void(0)" class="sub-btn btn btn-warning text-capitalize skip_survey">Skip for now</a>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>

...
$value = Yii::$app->request->get('PilotFrontCoreHighfiveSearch');
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:0px;"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/core/dashboard">&lt; Dashboard</a></div>
                ...
                <div class="pilot-front-highfive-search">
                    ...
                    <div class='tt-scrollable-menu'>
                        <div class="form-group">
                            <input id="project" class='form-control tt-hint' name='PilotFrontCoreHighfiveSearch[user_id]' placeholder='Search for teammate' value='<?= $name ?>'>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 shoutouts-paddings">
            <div class="btn-group sht_btn">
                ...
                <button type="button" class="btn btn-primary shoutoutsgiven ic_btn_1 shout1" data-tabname="region" style="color:#2e6da4;;background:#fff" rel="1">Shout Outs Recieved</button>
                    ...
                    <div class="table_1"   >
                        ...
                        echo ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $index, $widget) use ($count) {
                                ...
                                $check_comment_liked = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->one();
                                ...
                                $total_likes = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->all();
                                //Total Comments
                                $total_comments = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $model->id])->all();
                                //Comment Image
                                $comment_image = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $model->id])->all();
                                ?>
                                    ...
                                    <div class="points-data record-tr <?= $cls ?>">
                                        ...
                                        <div class="count highfive">
                                            ...
                                            <div class=comment_count>
                                                <span> (<span class="c_count <?= $model->id; ?>"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $model->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:hsl(25, 100%, 50%)"> Add Comment</a></span>
                                            </div>
                                        </div>

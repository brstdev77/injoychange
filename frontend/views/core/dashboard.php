...
if (in_array(11, $feature_array)):
    ...
    $query = PilotFrontCoreHighfive::find()->where(['not in', 'id', $subQuery])->andWhere(['challenge_id' => $game_id])->andWhere(['=', 'feature_label', 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
    $count = $query->count();
    if ($count > 20) {
        $limit = 0;
    } else {
    ...
    $count = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC])->count();
    if ($count > 20) {
        $limit = 0;
    } else {
        $limit = 1;
...
$subQuery1 = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage'])->select('linked_feature_id');
$query1 = PilotFrontCoreHighfive::find()->where(['in', 'id', $subQuery1])->andWhere(['=', 'feature_label', 'highfiveComment'])->andWhere(['week_no' => $week_no])->andWhere(['user_id' => $user_id])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img <?= $rating1; ?>1">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/core/daily-inspiration">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                    ...
                    <div class=bg-color>
                        ...
                        <div class="place <?= $place;?>">
                            ...
                            <div class="addmore-seeall <?= $see_all;?>" >
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/core/high-five">See All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                                        ...
                                        <div class="highfivecomment">
                                            <?php if (count($all_highfives) == 0): ?>
                                                ...
                                                foreach ($all_highfives as $hghfv):
                                                    ...
                                                    $check_comment_liked = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                                    ...
                                                    $total_likes = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                                    //Total Comments
                                                    ...
                                                    //Comment Image
                                                    $comment_image = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                                    ?>
                                                        ...
                                                        <div class=count>
                                                            ...
                                                            if (!empty($comment_option)):
                                                                ...
                                                                <div class=comment_count>
                                                                    <span> (<span class="c_count <?= $hghfv->id; ?>"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $hghfv->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:hsl(25, 100%, 50%)"> Add Comment</a></span>
                                                                </div>
                                                            <?php endif; ?>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            <div class=toolbox-lc-left>
                                ...
                                <p style="text-align: center;margin: 0;font-size: 12px;margin-top: -2px;"><?= $designation; ?></p>
                            </div>
                            ...
                            <div class=submitleader>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/core/toolbox">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=submitweek>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/core/weekly">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=align-center>
                                ...
                                <span class=see-al><a href="<?= $baseurl; ?>/core/share-a-win">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="points-data record-tr <?= $cls ?>">
                    ...
                    <div class="count highfive">
                        ...
                        <div class=comment_count>
                            <img src="../images/msg.png" /><span> (<span class="c_count <?= $model->id; ?>" style="color:#184473"><?= count($total_comments); ?></span>)<a onclick="saveusercomment(this, event)" href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $model->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:#184473"> Add Comment</a></span>
                        </div>
                    </div>

    ...
    <div class="content main-dashboard-banners">
                                ...
                                <div class="outer_performer_graph">
                                    ...
                                    <div class="outer_leaderboard action2">
                                        ...
                                        <div class="leaderboard_img2">
                                            <span>Core Values Practiced</span>
        ...
        <div class=row>
            <div class="dashboard-title leaderboard-title">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/intentional/dashboard">&lt; Dashboard</a></div>   
            </div>
        </div>
        <div class=row>
            <?php

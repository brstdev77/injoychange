...
$value = Yii::$app->request->get('PilotFrontIntentionalHighfiveSearch');
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:0px;"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/intentional/dashboard">&lt; Dashboard</a></div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 high-five-title"><?= $game_obj->highfive_heading;?></div>
                ...
                <div class="pilot-front-highfive-search">
                    ...
                    <div class='tt-scrollable-menu'>
                        <div class="form-group">
                            <input id="project" class='form-control tt-hint' name='PilotFrontIntentionalHighfiveSearch[user_id]' placeholder='Search for teammate' value='<?= $name ?>'>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 shoutouts-paddings">
            <div class="btn-group sht_btn">
                ...
                <button type="button" class="btn btn-primary shoutoutsgiven rgn_btn_2 shout0" data-tabname="icac" rel="0">Share a Win Given</button>
                <button type="button" class="btn btn-primary shoutoutsgiven ic_btn_1 shout1" data-tabname="region" style="color:#EE1C25;;background:#fff" rel="1">Share a Win Recieved</button>
                ...
                <div class="table-points">
                    <div class="table_1"   >
                        <div class="main-header">
                            ...
                            <div class="shout header">Share A Win </div>
                        ...
                        echo ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $index, $widget) use ($count) {
                                ...
                                $check_comment_liked = PilotFrontIntentionalHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->one();
                                ...
                                $total_likes = PilotFrontIntentionalHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->all();
                                //Total Comments
                                $total_comments = PilotFrontIntentionalHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $model->id])->all();
                                //Comment Image
                                $comment_image = PilotFrontIntentionalHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $model->id])->all();
                                ?>
                                    ...
                                    <div class="points-data record-tr <?= $cls ?>">
                                        ...
                                        <div class="count highfive">
                                            ...
                                            <div class=comment_count>
                                                <img src="../images/msg.png" /><span> (<span class="c_count <?= $model->id; ?>" style="color:#184473"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $model->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:#184473"> Add Comment</a></span>
                                            </div>
                                        </div>

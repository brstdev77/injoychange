...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/intentional/dashboard">&lt; Dashboard</a></div>
                ...
                <div class="table-points">
                    <div class="table_1">
                        <div class="main-header">
                            ...
                            <div class="core_val header">Core Value</div>

...
<style>
    ...
    .intentional_button{
        border-radius: 3px;
        background-image: -moz-linear-gradient( 90deg, rgb(237,28,37) 0%, rgb(255,91,91) 50%, rgb(237,28,37) 100%) !important;
        background-image: -webkit-linear-gradient( 90deg, rgb(237,28,37) 0%, rgb(255,91,91) 50%, rgb(237,28,37) 100%) !important;
        background-image: -ms-linear-gradient( 90deg, rgb(237,28,37) 0%, rgb(255,91,91) 50%, rgb(237,28,37) 100%) !important;
        box-shadow: 0px 4px 16.49px 0.51px rgba(0, 0, 0, 0.7);
    }
</style>
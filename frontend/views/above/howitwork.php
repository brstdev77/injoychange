...
<div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/above/dashboard">&lt; Dashboard</a></div>
...
<div class="work_content">
        ...
        <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/daily.png" /></p>
                </div>                     
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/check.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
 ...
 <li><h4>Points Value:  </h4>
                ...
                <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/point.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
 ...
 <li><h4>Each day you will be able to see your points, keep track of your goals and who the overall leaders are.</h4></li>
                    ...
                    <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/hive.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                     ...
                     <h3>Shout Out &amp; Digital High 5's</h3>
                        ...
                        <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/leader.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
...
<li><h4>The toolbox section will become a library of memorable tools and insights for you to take with you throughout this challenge and beyond. 
  ...
  <li><h4>Points Value = 10 points per day</h4></li>
                            ...
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/week.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                     ...
                     <h3>Weekly Challenge</h3>
                        ...
                        <ul>
                            ...
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                       <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/share.png" /></p>
                </div>                     
<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">

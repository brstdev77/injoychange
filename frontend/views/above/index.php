...
$this->title = 'Landing | Above & Beyond';
...
<img class=main-banner src="<?= $baseurl; ?>/images/bannerabove.png" alt=banner height=392 width=1180 />
</div>
</div>
</div>
...
<div class="home_page_text">
    ...
    <h1 class="rtecenter"><strong> Welcome to the 30 - Day Above & Beyond Challenge!</strong></h1>
...
<!-- <li><a href="<?//= $baseurl; ?>/above/dashboard" class=name_user>Dashboard</a> </li>-->
</ul>
    <?php

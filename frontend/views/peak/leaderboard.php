...
$action = $text['0'].' '.ucfirst(strtolower($text['1'])).' ';
$title = ucwords($text1);
    ...
    <div class="content main-dashboard-banners">
                            ...
                            <div class="top-performer-graph">
                                <div class="outer_performer_graph">
                                    <div class="outer_leaderboard action1">            
                                        <div class="first leaderboard_actions <?= $shoutouts; ?>"><?= $login_user_team_high5s; ?></div>
                                    ...
                                    <div class="outer_leaderboard action2">
                                        ...
                                        <div class="leaderboard_img2">
                                            <span>P.E.A.K. Concepts Practiced</span>
                                            <img src="../images/core_values.png">
                                        </div>
                                    </div>     
                                    <div class="outer_leaderboard action3">
                                        <div class="third leaderboard_actions <?= $wins; ?>"><?= $login_user_team_wins; ?></div>
                                        <div class="leaderboard_img3">
                                            <span>Your Actions Matter</span>
                                ...
                                <div class="top-performer-banner-elevation">
                                    <div class="leaderboard-elevation-number">
                                        <div class="elevating-count">
                                            ...
                                            <div class="top-performer-elevation-title">Total <?= $action; ?>Actions</div>
                                        </div>
        ...
        <div class=row>
            <div class="dashboard-title leaderboard-title">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/peak/dashboard">&lt; Dashboard</a></div>   
            </div>
        </div>
        <div class=row>
            <?php

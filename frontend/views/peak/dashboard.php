...
if (in_array(11, $feature_array)):
    ...
    $query = PilotFrontPeakHighfive::find()->where(['not in', 'id', $subQuery])->andWhere(['challenge_id' => $game_id])->andWhere(['=', 'feature_label', 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
    $count = $query->count();
    if ($count > 20) {
        $limit = 0;
    } else {
    ...
    $count = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC])->count();
    if ($count > 20) {
        $limit = 0;
    } else {
        $limit = 1;
...
$subQuery1 = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage'])->select('linked_feature_id');
$query1 = PilotFrontPeakHighfive::find()->where(['in', 'id', $subQuery1])->andWhere(['=', 'feature_label', 'highfiveComment'])->andWhere(['week_no' => $week_no])->andWhere(['user_id' => $user_id])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
...
if (empty($leadership_entry_weekly)):
    ...
    $sec_lock_img = 'peak_lock.png';
    $third_lock_img = 'peak_lock.png';
...
if ($last_action == 'login' || $last_action == 'signup'):
    $this->registerJs("
        $(document).ready(function(){
        $('body').addClass('fixedposition');
         $('#loginwelcome').modal('show');
        });
");
endif;

if ($show_survey == 'true' && $last_action != 'login' && $last_action != 'signup'):
    $this->registerJs("
        $(document).ready(function(){
         $('#survey').modal('show');
...
<div class="site-index">
    <div class="content main-dashboard-banners">
        <!----Show-survey value --->
        <input type="hidden" value="<?= $show_survey; ?>" id="show_survey" />
        <input type="hidden" value="<?= $last_action; ?>" id="last_action" />
        <!--<div class=container>-->
        <div class=row>
            <div class=col-md-12>
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img <?= $rating1; ?>1">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/peak/daily-inspiration">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                                ...
                                <div class=base_pt>
                                    ...
                                    <h6>
                                        <span class="prog_last_community load_actions ajax_img">
                                            <img src="../images/ajax_loader_blue.gif" width="auto" height="auto">
                                        </span>
                                    </h6>
                                </div>
                            </div>
                ...
                <div class=s_checkin>
                    <div class=bg-color>
                        <h1 class="heading new">
                            <a class=checkin-calendaricon href="calendar"><img src="<?= $baseurl; ?>/images/peak_calander.png" alt="" height=24 width=25></a>Check in with yourself
                            <span class="icon_right" href="smartphone" data-toggle="modal" data-modal-id="smartphone"><img src="<?= $baseurl; ?>/images/peak_software.png" alt="" height=26 width=16></span>
                        </h1>
                                ...
                                <?php if (empty($prev_today_values_currentday)): ?>
                                    ...
                                    <div>
                                        ...
                                        <div class='checkin-seeall <?= $rating; ?>'>
                                            ...
                                            ?>
                                            <a href="<?= $baseurl; ?>/peak/checkin" class="">See All&nbsp;<span><i class="fa fa-angle-right"></i></span></a></div>
                                    </div>
                                <?php else: ?>
                                    <div id="today_values">
                    ...
                    <div class=bg-color>
                        ...
                        <div class="place <?= $place; ?>">
                            ...
                            <div class="addmore-seeall <?= $see_all; ?>" >
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/peak/high-five">See All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                                        ...
                                        <div class="highfivecomment">
                                            <?php if (count($all_highfives) == 0): ?>
                                                ...
                                                foreach ($all_highfives as $hghfv):
                                                    ...
                                                    //Comment Image
                                                    $comment_image = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                                    ?>
                                                        ...
                                                        <div class=count>
                                                            ...
                                                            if (!empty($comment_option)):
                                                                ...
                                                                <div class=comment_count>
                                                                    <img src="../images/msg.png" /><span> (<span class="c_count <?= $hghfv->id; ?>" style="color:#184473"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $hghfv->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:#184473"> Add Comment</a></span>
                                                                </div>
                                                            <?php endif; ?>
...
<!--                            <div class="col-md-12 action-matters" style="color:#666c78;min-height: 44px;max-height: 44px;text-align:center;"><?= $question; ?></div>-->
                            <div class=toolbox-lc-left>
                                ...
                                <p class="leadership_title" style="color:#595E6E;"><?= $tip_title; ?></p>
                            ...
                            <div class=submitleader>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/peak/toolbox">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=submitweek>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/peak/weekly">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12 lightbox">
                    <div class=today_g>
                        ...
                        <div class=content>
                            <div class="col-md-12 action-matters" style="color:#1B5292;font-family:lato-bold;">What's one way you built credibility this week?</div>
                                ...
                                <div class=box3shareawin>
                                    <div href="share-a-bin-modal" data-toggle="modal" data-modal-id="share-a-win" class="checkbox checkbox1 box3">
                                        <div class=label1>
                                            ...
                                            <span> Share Your Answer 30 Pts  </span>                                  
                                        </div>
                                    </div>
                                </div>
                                <span class=see-al><a href="<?= $baseurl; ?>/peak/share-a-win">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-form">
                        ...
                        <div class = "modal-footer">
                            ...
                            <a href="javascript:void(0)" class="sub-btn btn btn-warning text-capitalize skip_survey" style="margin-top:20px;background-image: -moz-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                               background-image: -webkit-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                               background-image: -ms-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                               box-shadow: 0px 4px 16.49px 0.51px rgba(0, 0, 0, 0.7);">Skip for now</a>
                        </div>
                        <?php ActiveForm::end(); ?>
                    </div>
                </div>
    ...
    <?php endif; ?>
    <div class="modal fade" role="dialog" id="loginwelcome" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">       
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"></button>
                    <h4 class="modal-title">My Action Plan For P.E.A.K. Influence</h4>
                </div>

                <div class="modal-body"> 
                    <div class="container-fluid" >
                        <h5>Welcome to the 30-Day P.E.A.K. Influence Challenge!</h5>
                        If you have not already done so, please <a href="http://injoyglobal.com/peak" target="_blank">click here</a> to complete your action plan survey.
                    </div>
                </div>

                <div class = "modal-footer">
<!--                    <a href="http://peak.injoyglobal.com/survey" target="_blank" class="sub-btn btn btn-warning text-capitalize save_plan" style="margin-top:20px;background-image: -moz-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       background-image: -webkit-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       background-image: -ms-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       box-shadow: 0px 4px 16.49px 0.51px rgba(0, 0, 0, 0.7);">Save My Action Plan</a>-->
                    <a href="javascript:void(0)" class="sub-btn btn btn-warning text-capitalize plan_survey" style="margin-top:20px;background-image: -moz-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       background-image: -webkit-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       background-image: -ms-linear-gradient( 90deg, rgb(24,68,115) 0%, rgb(53,114,179) 50%, rgb(25,81,142) 100%);
                       box-shadow: 0px 4px 16.49px 0.51px rgba(0, 0, 0, 0.7);">Begin Challenge Now</a>
                </div>

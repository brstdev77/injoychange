...
//echo $game_obj->highfive_heading;die;
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:0px;"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/peak/dashboard">&lt; Dashboard</a></div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 shoutouts-paddings">
            <div class="btn-group sht_btn">
                ...
                <button type="button" class="btn btn-primary shoutoutsgiven ic_btn_1 shout1" data-tabname="region" style="color:#2e6da4;;background:#fff" rel="1">Share a Win Recieved</button>
                       ...
                       Pjax::begin(['enablePushState' => false]);
                        echo ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $index, $widget) use ($count) {
                                ...
                                $check_comment_liked = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->one();
                                ...
                                $total_likes = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->all();
                                //Total Comments
                                $total_comments = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $model->id])->all();
                                //Comment Image
                                $comment_image = PilotFrontPeakHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $model->id])->all();
                                ?>

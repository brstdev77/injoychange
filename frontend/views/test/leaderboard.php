...
$this->title = 'Leaderboard | Welcome To InJoy';
    ...
    <div class="content main-dashboard-banners">
                                ...
                                <div class="top-performer-banner-elevation">
                                    <div class="leaderboard-elevation-number">
                                        <div class="elevating-count">
                                            ...
                                            <div class="top-performer-elevation-title">Total InJoy Actions</div> 
                                        </div>
                                    </div>
                                </div>  
                            </div>
        ...
        <div class=row>
            <div class="dashboard-title leaderboard-title">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/learning/dashboard">&lt; Dashboard</a></div>   
            </div>
        </div>
        <div class=row>
            <?php

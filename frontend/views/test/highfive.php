...
$value = Yii::$app->request->get('PilotFrontTestHighfiveSearch');
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom: 0"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/test/dashboard">&lt; Dashboard</a></div>
                ...
                <div class="pilot-front-highfive-search">
                    ...
                    <div class='tt-scrollable-menu'>
                        <div class="form-group">
                            <input id="project" class='form-control tt-hint' name='PilotFrontTestHighfiveSearch[user_id]' placeholder='Search for teammate' value='<?= $name ?>'>
                ...
                <div class="table-points">
                    <div class="table_1"   >
                        <div class="main-header">
                            ...
                            <div class="shout header">Shout Outs</div>

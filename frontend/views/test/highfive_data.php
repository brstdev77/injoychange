...
$j=1;
 if (count($all_highfivecomment) == 0): ?>
                                        ...
                                        foreach ($all_highfivecomment as $hghfv):
                                            ...
                                            $check_comment_liked = PilotFrontTestHighfive::find()->where(['feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id,'user_id' => $user_id])->one();
                                            ...
                                            $total_likes = PilotFrontTestHighfive::find()->where(['feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                            //Total Comments
                                            $total_comments = PilotFrontTestHighfive::find()->where(['feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                            //Time
                                            ...
                                            $comment_image = PilotFrontTestHighfive::find()->where(['feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                            ?>

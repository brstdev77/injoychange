...
$upcoming_challenge = PilotCreateGame::find()->where(['challenge_company_id' => $company_id, 'status' => [0,1]])
...
$welcome_msg = ucwords($upcoming_challenge_name) . '!';
...
<?php $this->registerJsFile($baseurl . "/js/welcome.js", ['position' => yii\web\View::POS_END, 'depends' => ['yii\web\JqueryAsset']]);?>

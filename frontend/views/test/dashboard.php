...
$this->title = 'Dashboard | Welcome To InJoy';
$baseurl = Yii::$app->request->baseurl;
$game = \frontend\models\PilotFrontUser::getGameID('test');
$user_id = Yii::$app->user->identity->id;
$comp_id = Yii::$app->user->identity->company_id;
$challenge_id = \frontend\models\PilotFrontUser::getGameID('test');
...
if (empty($audio_entry_weekly)):
    ...
    $first_lock_img = 'unlock-test.png';
...
if (!empty($audio_entry_sec)):
    if (empty($audio_entry_currentday)):
        ...
        $third_li_cls = 'enable';
        $sec_lock_img = 'unlock-test.png';
        $third_lock_img = 'unlock-test.png';
        $sec_modal_link = 'audio-modal?tip=second';
...
if (empty($know_entry_weekly)):
    ...
    $first_lock_img_know = 'unlock-test.png';
...
if (!empty($know_entry_first)):
    if (empty($know_entry_currentday)):
        ...
        $first_lock_img_know = 'unlock-test.png';
        $sec_lock_img_know = 'unlock-test.png';
        $first_modal_link_know = 'know-modal?tip=first';
...
if (empty($answer_entry_weekly)):
    $answer_btn_cls = 'unchecked';
    $answer_tip_pos = 'first';
endif;
if (!empty($answer_entry_first)):
    if (empty($answer_entry_currentday)):
        $answer_btn_cls = 'unchecked';
        $answer_tip_pos = 'second';
    else:
        $answer_btn_cls = 'checked';
        $answer_tip_pos = 'first';
    endif;
endif;
if (!empty($answer_entry_sec)):
    if (empty($answer_entry_currentday)):
        $answer_btn_cls = 'unchecked';
        $answer_tip_pos = 'third';
    else:
        $answer_btn_cls = 'checked';
        $answer_tip_pos = 'second';
    endif;
endif;
if (!empty($answer_entry_third)):
    $answer_btn_cls = 'checked';
    $answer_tip_pos = 'third';
endif;
//Tip Image  & Title
        ...
        <div class=row>
            <div class=col-md-12>
                <div class=main-dashboard-banner>
                    ...
                    <?php } else { ?>
                        <img class=main-banner src="http://root.injoymore.com/backend/web/img/game/welcome_banner/1518767329.png" alt=banner height=392 width=1180 />  
                    <?php } ?>
                </div>
            </div>
        </div>
        <div class=row>
            <div class="col-md-4 col-sm-4 outer_left">
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/test/daily-inspiration">View All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                ...
                <div class="today_g">
                    ...
                    <div class="content">
                        <div class="tool">
                            <img width="158" height="344" alt="week" src="../images/didyouknow.png" class="video">
                        </div>
                ...
                <div class="today_g">
                    <div class="today_gratitude">
                        <h1 class="heading">GET TO KNOW THE TEAM</h1>
                    </div>
                    <?php if ($answer_tip_pos == 'first'): ?>
                       <div class="content">
                            <p class="question_know">Which InJoy Team Member did NOT say most people don't know that they like to sleep?</p>
                            <div class="user-info1">
                                <img src="http://injoyglobal.com/wp-content/uploads/2017/02/8.jpg" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Holly B.Etzell</p>
                                <div class="submitleader" href='answer1-modal?tip=first' data-toggle="modal" data-modal-id="answer1">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                            ...
                            <div class="user-info1">
                                <img src="/uploads/1512029219_5a1fbc2342032.png" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Pradeep Sharma</p>
                                <div class="submitleader" href='answer2-modal?tip=first' data-toggle="modal" data-modal-id="answer2">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="user-info1">
                                <img src="/uploads/1509688959_59fc067f478f7.png" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Kunal Khullar</p>
                                <div class="submitleader" href='answer3-modal?tip=first' data-toggle="modal" data-modal-id="answer3">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="submitleader">
                                <div class="checkbox checkbox1 core_value question_completed">
                                    <div class="label1"><input type=checkbox>
                                        <label class='<?= $answer_btn_cls; ?>'></label>
                                        <span>COMPLETED</span>
                                    </div>
                                </div>
                                <span class="see-al"><a href="<?= $baseurl; ?>/test/know-the-team">View All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    <?php endif; ?>
                    <?php if ($answer_tip_pos == 'second'): ?>
                     <div class="content">
                            <p class="question_know">Which InJoy Team Member said most people don't know they were a tennis star at some point in their life?</p>
                            <div class="user-info1">
                                <img src="http://injoyglobal.com/wp-content/uploads/2017/02/rakesh.jpg" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Rakesh Sanghvi</p>
                                <div class="submitleader" href='answer1-modal?tip=second' data-toggle="modal" data-modal-id="answer1">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="user-info1">
                                <img src="http://injoyglobal.com/wp-content/uploads/2017/02/jeff2.jpg" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Jeff <br/>Baietto</p>
                                <div class="submitleader" href='answer2-modal?tip=second' data-toggle="modal" data-modal-id="answer2">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="user-info1">
                                <img src="http://injoyglobal.com/wp-content/uploads/2017/02/6.jpg" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Elly <br/>Bannon</p>
                                <div class="submitleader" href='answer3-modal?tip=second' data-toggle="modal" data-modal-id="answer3">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                    ...
                    <?php endif; ?>
                    <?php if ($answer_tip_pos == 'third'): ?>
                        <div class="content">
                            <p class="question_know">Who's favorite holiday is NOT Christmas?</p>
                            <div class="user-info1">
                                <img src="/images/know_rajat.png" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Rajat <br/> Saini</p>
                                <div class="submitleader" href='answer1-modal?tip=third' data-toggle="modal" data-modal-id="answer1">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="user-info1">
                                <img src="/uploads/1512029219_5a1fbc2342032.png" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Pradeep Kumar</p>
                                <div class="submitleader" href='answer2-modal?tip=third' data-toggle="modal" data-modal-id="answer2">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                            ...
                            <div class="user-info1">
                                <img src="http://injoyglobal.com/wp-content/uploads/2017/02/linda2.jpg" alt="1">
                                <p style="float: left; margin-top: 5px; font-family: lato-bold;width:100%">Linda <br/>LoRe</p>
                                <div class="submitleader" href='answer3-modal?tip=third' data-toggle="modal" data-modal-id="answer3">
                                    <!--div class="checkbox checkbox1 core_value" data-modal-id="weekly-challenge" data-toggle="modal" href="weekly-modal"-->
                                    <div class="checkbox checkbox1 core_value">
                                        <div class="label1">
                                            <span>SELECT</span>
                    ...
                    <div class="bg-color">
                        <div class="value">
                            <!--                            <div class="inner_new">
                                                            ...
                                                            <div class="value_content">
                                                                <div class="activecontent">
                                                                    <h4>Why Focus on Culture</h4>
                                                                    <p>All people exhibits form of unconscious bias.while some bias have very little impact,others can have an  extremely negative oganizational impact.</p>
                                                                    <span>Watch now to learn more!</span>	
                                                                </div>
                                                                <div class="submitcore">
                                                                    div class="checkbox checkbox1 core_value" data-modal-id="core-values" data-toggle="modal" href="core-values-modal"
                                                                    <div class="checkbox checkbox1 core_value" href="core-values-modal">
                                                                        <div class="label1"><input type="checkbox">
                                                                ...
                                                                <div class='col-xs-4 col-md-4 new_leader'>
                                                                    <img src='../images/lock2.png' /><p>FIRST</p>
                                                                </div>
                                                                <div class='col-xs-4 col-md-4 new_leader'>
                                                                    <img src='../images/lock123.png' /><p>SECOND</p>
                                                                </div>
                                                                <div class='col-xs-4 col-md-4 new_leader'>
                                                                    <img src='../images/lock123.png' /><p>THIRD</p>
                                                                </div>
                                                            </div>
                                                        </div>-->
                            <div class="form">
                                ...
                                <div class="checkin_test">
                                    ...
                                    <!--div class="toolbox-lc-right">
                                        <ul>
                                            <li class="enable">
                                                <div class="li-text">
                                                    <a data-toggle="modal" class="" data-modal-id="leadership-corner" href="leadership-modal?tip=first"> First</a>
                                                </div>
                                                <div class="li-img">
                                                    <img src="../images/unlock-test.png">
                                                </div>
                                            </li>
                                            <li class="disable">
                                                <div class="li-text">
                                    ...
                                    <div class="col-xs-5 col-md-5 injoy_team">
                                        <div class="value_content">
                                            <div class="activecontent">
                                                <!--h4>Why Focus on Culture</h4-->
                                                <p>Check out your team member's answers around their superpowers, their favorite InJoy value or how they got to be on the InJoy team.</p>
                                                <!--span>Watch now to learn more!</span-->	
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="today_values">
                                ...
                                <a class="" href="<?= $baseurl; ?>/learning/toolbox">View All&nbsp;<span><i class="fa fa-angle-right"></i></span></a>
                            </div> 
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-color">
                        ...
                        <div class=place>
                            ...
                            <div class=addmore-seeall>
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/learning/high-five">View All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                                ...
                                <div class='highfivecomment'>
                                    <?php if (count($all_highfives) == 0): ?>
                                        ...
                                        foreach ($all_highfives as $hghfv):
                                            ...
                                            $check_comment_liked = PilotFrontTestHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                            ...
                                            $total_likes = PilotFrontTestHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                            //Total Comments
                                            $total_comments = PilotFrontTestHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                            //Time
                                            $created = $hghfv->created;
                                            $cmnt_time = date('M d, Y h:i A', $created);

                                            //Comment Image
                                            $comment_image = PilotFrontTestHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                            ?>
...
<div class="modal fade" role="dialog" id="answer1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"></button>
                <h4 class="modal-title">Get to know the team</h4>
            </div>
            <div class="modal-form">
                <div class="modal-ajax-loader">  
                    <img src="../images/ajax-loader.gif"/>
...
<div class="modal fade" role="dialog" id="answer2" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"></button>
...
<div class="modal fade" role="dialog" id="answer3" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-form">
                    ...
                    <div class = "modal-footer">
                        ...
                        <a href="javascript:void(0)" class="sub-btn btn btn-warning text-capitalize skip_survey" style="margin-top:20px;">Skip for now</a>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>

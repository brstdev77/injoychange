...
$this->registerCssFile(Yii::$app->homeUrl . 'css/seeall.css');
...
<?php $this->registerJsFile(Yii::$app->homeUrl . 'js/audio.js', ['position' => yii\web\View::POS_END, 'depends' => ['yii\web\JqueryAsset']]); ?>

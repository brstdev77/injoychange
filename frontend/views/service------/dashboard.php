                        ...
                        <div class=place>
                            ...
                            if (in_array(11, $feature_array)):
                                ...
                                <div class="btn-group sht_btn dashboard_button">
                                    ...
                                    <button type="button" class="btn btn-primary shoutoutsgiven highfiveimage shout1" data-tabname="region" style="color:rgb(46, 109, 164);background:#fff" rel="1">5S IN ACTION</button>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if (in_array(11, $feature_array)): ?>
                                <div class="outer-content appreciation">

    ...
    <div class="modal-body">
            ...
            <div class="maildaily" style="display:none">
                <div class="sendmailerform">
                    ...
                    <div class="form-group">
                        <?= Html::submitButton('SEND', ['class' => 'sub-btn btn btn-warning dashboard text-capitalize','id' => 'mail-submit']) ?>
                    </div>
                    <?php ActiveForm::end(); ?>
        ...
        <div class = "modal-footer">
            ...
            <?php if (empty($daily_entry)): ?>
                <?= Html::submitButton('Submit 10 pts', ['class' => 'sub-btn btn btn-warning text-capitalize','style' => 'float:left;']); ?>
            <?php endif; ?> 
...
if (isset($today_valuesModel)):
    ...
    <?php if (isset($action)): ?>
        ...
        ?>
                ...
                <?= $form->field($today_valuesModel, 'comment', ['inputOptions' => ['placeholder' => "$placeholder_text", 'class' => 'good-news-textarea form-textarea required form-textarea', 'onkeyup' => 'return max_char_length(this,event);']])->textarea(['id' => 'core_value_area', 'maxlength' => 100])->label(false); ?>
                            </div>
                        </div>
            ...
            <div class="new-mail-submit">
                <div class="new_text">
                    <div class=submit-image>
                        <span class="background-checkbox <?= $tv_cls1; ?>"></span>
                        <span class="background-checkbox <?= $tv_cls2; ?>"></span>
                        <input id=new-mail-submit class="new-user-submit btn btn-primary form-submit mdl-btn2" name=op value="<?= $tv_btn_text; ?>" type=submit>
                    </div>
                </div>
            </div>
...
<?php if (isset($leadership_model)): ?>
    ...
    ?>
                ...
                <div class="tip_title"><?= $leadership_tip_obj->title; ?></div>
                <div class="tip_des"><?= $leadership_tip_obj->description; ?></div>
            </div>
        </div>
    </div>
    <div class = "modal-footer">
...
<?php if (isset($weekly_model)): ?>
    ...
    <?= $form->field($weekly_model, 'comment', ['template' => '{input}{error}', 'inputOptions' => ['onkeyup' => 'return max_char_length(this,event);', 'class' => 'form-control']])->textarea(['maxlength' => 255]);
    ?>
        <div class="text-length"><span></span></div>
...
<?php if (isset($shareawin_model)): ?>
    ...
    echo $form->field($shareawin_model, 'comment', ['template' => '{input}{error}', 'inputOptions' => ['placeholder' => '', 'onkeyup' => 'return max_char_length(this,event);', 'class' => 'form-control ']])->textarea(['maxlength' => 150]);
    ?>
            <div class="text-length"><span></span></div>
        </div>
    </div>

...
$value = Yii::$app->request->get('PilotFrontLeadershipHighfiveSearch');
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:0px;"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leadership/dashboard">&lt; Dashboard</a></div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 high-five-title">SHOUT OUT & DIGITAL HIGH 5'S</div>
                ...
                <div class="pilot-front-highfive-search">
                    ...
                    <div class='tt-scrollable-menu'>
                        <div class="form-group">
                            <input id="project" class='form-control tt-hint' name='PilotFrontLeadershipHighfiveSearch[user_id]' placeholder='Search for teammate' value='<?= $name ?>'>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 shoutouts-paddings">
            <div class="btn-group sht_btn">
                ...
                <button type="button" class="btn btn-primary shoutoutsgiven ic_btn_1 shout1" data-tabname="region" style="color:#131313;;background:#fff" rel="1">Shout Outs Recieved</button>
                    ...
                    <div class="table_1"   >
                        ...
                        echo ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $index, $widget) use ($count) {
                                ...
                                $check_comment_liked = PilotFrontLeadershipHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->one();
                                ...
                                $total_likes = PilotFrontLeadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->all();
                                //Total Comments
                                $total_comments = PilotFrontLeadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $model->id])->all();
                                //Comment Image
                                $comment_image = PilotFrontLeadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $model->id])->all();
                                ?>

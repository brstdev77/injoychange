        ...
        <?php endif; ?>
                ...
                <div class="count highfive">
                    ...
                    <div class=comment_count>
                        <span> (<span class="c_count <?= $model->id; ?>"><?= count($total_comments); ?></span>)<a onclick="saveusercomment(this, event)" href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $model->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style='color:#cc1c1c'> Add Comment</a></span>
                    </div>
                </div>

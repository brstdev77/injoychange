...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:20px"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leads/dashboard">&lt; Dashboard</a></div>
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 high-five-title">Check in with yourself</div>
        </div>
        <div class="see-all-powers-outer">
            <div class="see-all-powers-inner">
                ...
                <div class="core_val header">5S Practiced</div>
                <div class="value1 header">Comment</div>                
                </div>
                        <?php

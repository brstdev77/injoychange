...
if ($userImage == ''):
    $userImagePath = '../images/user_icon.jpg';
else:
...
if (in_array(11, $feature_array) && in_array(7, $feature_array)):
    ...
    $place = 'place_height';
    $see_all = 'all_button';
    $button_text = ButtonToggle::find()->select('Button_text')->where(['game_id' => $model->id])->one();
    if(!empty($button_text)):
        $button = strtoupper($button_text->Button_text);
    else:
        $button = '5S IN ACTION';
    endif;
endif;
...
if (in_array(11, $feature_array)):
    ...
    $query = PilotFrontLeadsHighfive::find()->where(['not in', 'id', $subQuery])->andWhere(['challenge_id' => $game_id])->andWhere(['=', 'feature_label', 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
    $count = $query->count();
    if($count > 20){
        $limit = 0;
    }
     ...
     $count = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC])->count();
     if($count > 20){
        $limit = 0;
    }
    else{
...
$subQuery1 = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage'])->select('linked_feature_id');
$query1 = PilotFrontLeadsHighfive::find()->where(['in', 'id', $subQuery1])->andWhere(['=', 'feature_label', 'highfiveComment'])->andWhere(['week_no' => $week_no])->andWhere(['user_id' => $user_id])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
...
//if (!empty($all_highfiveImage1)):
//    foreach ($all_highfiveImage1 as $highfive1):
//        $serial1 = $highfive1->feature_serial;
//    endforeach;
//    $feature_serial1 = $serial1++;
//else:
$feature_serial1 = 1;
//endif;
//Leadership Corner
if (empty($leadership_entry_weekly)):
    ...
    $first_lock_img = 'unlockleads.png';
    $sec_lock_img = 'lockleads.png';
    $third_lock_img = 'lockleads.png';
...
if (!empty($leadership_entry_sec)):
    if (empty($leadership_entry_currentday)):
        ...
        $third_li_cls = 'enable';
        $sec_lock_img = 'unlockleads.png';
        $third_lock_img = 'unlockleads.png';
        $sec_modal_link = 'leadership-modal?tip=second';
...
if ($show_survey == 'true'):
    $this->registerJs("
        $(document).ready(function(){
         $('#survey').modal('show');
        $('body').addClass('fixedposition1'); 
          $('.skip_survey').on('click', function () {
          $('#survey').modal('hide');
         $('body').removeClass('fixedposition1');
              $.ajax({
                  type: 'post',
                  url: 'skip-survey',
                  data: {
        ...
        <div class=row>
            <div class=col-md-12>
                <div class=main-dashboard-banner>
                    ...
                    <?php } else { ?>
                        <img class=main-banner src="<?= $baseurl; ?>/images/banner_leads.png" alt=banner height=392 width=1180 />
                    <?php } ?>
                </div>
            </div>
        </div>
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img <?= $rating1; ?>1">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/leads/daily-inspiration">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                            ...
                            <div class=content1>
                                ...
                                <ul class=top_points>
                                    <div style="display: none;" class="loading-check-div" id="loading-scores1">
                                        <img src="../images/ajax-loader-leads.gif" id="loading-check-img" width="auto" height="auto">
                                    </div>
                                    ...
                                    <li class = abs><img src = "<?= $baseurl; ?>/images/raffle_ticket_sm2.png" alt = entry height = 47 width = 68> <p class = "entry pt">Tickets</p> </li>
                                </ul>
                                <?php
                                $bandClassMore = '';
                                ...
                                <div class=base_pt>
                                    ...
                                    <h6>
                                        <span class="prog_last_community load_actions ajax_img" style="display:none">
                ...
                <div class=s_checkin>
                    <div class=bg-color>
                        <h1 class="heading new">
                            <a class=checkin-calendaricon href="calendar"><img src="<?= $baseurl; ?>/images/leadscal.png" alt="" height=24 width=25></a>Check in with yourself
                            <span class="icon_right" href="smartphone" data-toggle="modal" data-modal-id="smartphone"><img src="<?= $baseurl; ?>/images/leadsmob.png" alt="" height=26 width=16></span>
                        </h1>
                        <div style="display: none;" id="loading-check1" class="loading-check-div">
                        ...
                        <div class=value>
                            <div class=value_content>
                                ...
                                <div class='submitcore <?= $rating1; ?>1 <?= $serial_class; ?>'>
                                        ...
                                        <div class='checkin-seeall <?= $rating; ?>'>
                                            <?php if (in_array(10, $feature_array)): ?>
                                                <?php if (empty($ratesaved)): ?>
                                                    ...
                                                    ?>
                                                    <?php echo '<label class="control-label">Rate Your Excellence In 5S Today</label>'; ?>
                                                    <?php
...
//                                                     'pluginEvents' => [
//                                                    'rating.change' => 'function() { alert("sasas") }',
//                                                    ]
                                                    ])->label(false);
                                                    ?>
                                            ...
                                            ?>
                                            <a href="<?= $baseurl; ?>/leads/checkin" class="">See All&nbsp;<span><i class="fa fa-angle-right"></i></span></a></div>
                                    </div>
                                <?php else: ?>
                                    <div id="today_values">
                                        <div class="Content-values-outer <?= $serial_class; ?>">
                                        ...
                                        <div class="new-mail-submit two <?= $button_rating; ?>1">
                                            <div class="col-sm-9 new_text">
                                                <div href="check-in-modal" data-toggle="modal" data-modal-id="check-in" class=submit-image>
                                                    ...
                                                    <input id=new-mail-submit class="new-user-submit btn btn-primary form-submit <?= $button; ?>" name=op value="<?= $tv_btn_text; ?>" type=button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="checkin-seeall <?= $tv; ?> <?= $rating; ?>1 <?= $rating1; ?>">
                                            <?php if (in_array(10, $feature_array)): ?>
                                                <?php if (empty($ratesaved)): ?>
                                                    <?php
                                                    $formrating = ActiveForm::begin([
                                            ...
                                            ?>
                                            <a class='<?= $serial_class; ?>' href="<?= $baseurl; ?>/leads/checkin" class="">See All&nbsp;<span><i class="fa fa-angle-right"></i></span></a></div>
                        ...
                        <div class="place <?= $place;?>">
                            ...
                            <div>
                                <div class="content pc">
                                    ...
                                    <input type="hidden" name="serial_comment" id="serial_comment" value="<?= $feature_serial; ?>" />
                                    <input type="hidden" name="serial_image" id="serial_image" value="<?= $feature_serial1; ?>" />
                                    <div class=submits>
                            ...
                            if (!empty($image_upload_shout)):
                                $enable_upload = 'yes';
                                ?>
                                <div class="upload_hf_image <?= $upload; ?>">
                                    <a class="hf_image_label" style="display:none">
                            ...
                            if (in_array(11, $feature_array)):
                                ...
                                <div class="btn-group sht_btn">
                                    <!--input type="hidden" name="lastupdated" id="lastupdated" value="<?= $lastupdated; ?>" /-->
                                    <input type='hidden' name='shoutout' id='shoutout' value='0' />
                                    <input type='hidden' name='imageuploaded' id='imageuploaded' value='0' />
                                    <button type="button" class="btn btn-primary shoutoutsgiven1 shout0 appreciation1" data-tabname="icac" rel="0">APPRECIATION</button>
                                    <button type="button" class="btn btn-primary shoutoutsgiven1 shout1 highfiveimage" data-tabname="region" style="color:#cc1c1c;background:#fff;" rel="1"><?= $button;?></button>
                                </div>
                            <?php endif; ?>
                            <input type="hidden" value="<?= $enable_upload; ?>" id="upload_image_feature"/>
                            <div class=addmore-seeall>
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/leads/high-five">See All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                        ...
                        <div class=outer-content>
                            ...
                            <div class="last-content <?= $content_height; ?> commentonly">
                                ...
                                <div class="highfivecomment">
                                    <?php if (count($all_highfivecomment) == 0): ?>
                                        ...
                                        foreach ($all_highfivecomment as $hghfv):
                                            ...
                                            $check_comment_liked = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                            ...
                                            $total_likes = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                            //Total Comments
                                            $total_comments = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                            //Time
                                            $created = $hghfv->created;
                                            $cmnt_time = date('M d, Y h:i A', $created);

                                            //Comment Image
                                            $comment_image = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                            ?>
                                                ...
                                                <div class=count>
                                                    ...
                                                    if (!empty($comment_option)):
                                                        ...
                                                        <div class=comment_count>
                                                            <span> (<span class="c_count <?= $hghfv->id; ?>"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $hghfv->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style='color:#cc1c1c'> Add Comment</a></span>
                                                        </div>
                                                    <?php endif; ?>
                                    ...
                                    <div class="highfivecomment">
                                        <?php if (count($all_highfives) == 0): ?>
                                            ...
                                            foreach ($all_highfives as $hghfv):
                                                ...
                                                $total_likes = PilotFrontLeadsHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                                //Total Comments
                                                $total_comments = PilotFrontCoreHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                                //Time
                                                $created = $hghfv->created;
                                                $cmnt_time = date('M d, Y h:i A', $created);
                    ...
                    <div class=content>
                        <div class=toolbox-lc-left>
                            <div class=img_b>
                             ...
                             <p class="leadership_title"><?= $tip_title; ?></p>
                        ...
                        <div class=submitleader>
                            ...
                            <span class="see-al"><a href="<?= $baseurl; ?>/leads/toolbox">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12 toolbox">
                <div class=today_g>
                    ...
                    <div class=content>
                        ...
                        <div class=submitweek style='position:relative'>
                            ...
                            <span class="see-al"><a href="<?= $baseurl; ?>/leads/weekly">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=today_g>
                    ...
                    <div class=content>
                                        ...
                                        foreach ($shareawins_all as $shareawin):
                                            ...
                                            if (strlen($share_comment) > $max_length) {
                                                ...
                                                if ($bar >= 1):
                                                    ...
                                                    $share_comment = substr($share_comment, 0, 50) . '...';
                                                endif;
                                            }
                                            ?>
                                                ...
                                                <div class=carousel-caption>
                                                    ...
                                                    <div class=share-user-data>
                                                        ...
                                                        if ($shareawin->userinfo->profile_pic) {
                                                            ...
                                                            $imagePath = Yii::$app->request->baseurl . '/images/user_icon.jpg';
                                                        }
                                                        ?> 
                        ...
                        <div class=align-center>
                            ...
                            <span class=see-al><a href="<?= $baseurl; ?>/leads/share-a-win">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-form">
                    ...
                    <div class = "modal-footer">
                        <?= Html::submitButton('Submit here', ['class' => 'sub-btn btn btn-warning text-capitalize survey_submit']); ?>

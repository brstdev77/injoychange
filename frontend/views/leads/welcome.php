...
$firstday = date('l', $upcoming_challenge->challenge_start_date);
$endday = date('l', $upcoming_challenge->challenge_end_date);
$challenge_start_date = date('F j', $upcoming_challenge->challenge_start_date);
$challenge_end_date1 = date('F j', $upcoming_challenge->challenge_end_date);
        ...
        <div class=row>
            <div class=col-md-12>
                ...
                <div class="wlcm_msg">
                    ...
                    <div class="chl_strt">This Challenge officially starts on <?=$firstday;?>, <?= $challenge_start_date; ?><sup><?= $challenge_start_date_ordinal; ?></sup> and goes to <?=$endday;?>, <?= $challenge_end_date1; ?><sup><?= $challenge_end_date_ordinal; ?></sup> so get ready to have some fun and go Above and Beyond! </div>

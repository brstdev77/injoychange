            ...
            <div class=col-md-12>
                ...
                <div class=login-infor>
                    ...
                    if (Yii::$app->user->isGuest) {
                        ?>
                        <ul class="">
                            <li><a href="<?= $baseurl; ?>/site/signup" class=name_user style="background:<?= $color; ?>">Register Now</a> </li>
                            <li><a href="<?= $baseurl; ?>/site/login" class=name_user style="background:<?= $color; ?>">Login</a> </li>
                        ...
                        ?>
                        <ul>
                            <li><a href="<?= $baseurl; ?>/core/dashboard" class=name_user style="background:<?= $color; ?>">Dashboard</a> </li>
                            <li><a><?php

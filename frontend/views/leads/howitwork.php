...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom:20px"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leads/dashboard">&lt; Dashboard</a></div>
...
<?php
    ...
    <div class="site-index">
        <div class="seeall-data">
            <div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leads/dashboard" style='background:<?= $color;?>'>&lt; Dashboard</a></div>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 high-five-title" style='color:<?=$color;?>'>How it works</div>
            </div>
            <div class="work_content">

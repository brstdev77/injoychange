    ...
    <div class="content main-dashboard-banners">
                    ...
                    <div class="top-performer-banner">
                        <div class="top-performer-banner-graph">
                            <div class="top-performer-banner-title-main">
                                <div class="performer-title" style='color:#e41515'>What You've Accomplished as a Team</div>
                            </div>
                                ...
                                <div class="top-performer-banner-elevation">
                                    <div class="leaderboard-elevation-number">
                                        <div class="elevating-count">
                                            ...
                                            <div class="top-performer-elevation-title">Total 5S Above and Beyond Action</div>
                                        </div>
        ...
        <div class=row>
            <div class="dashboard-title leaderboard-title">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leads/dashboard">&lt; Dashboard</a></div>   
            </div>
        </div>
        <div class=row>
            <?php

...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/leads/dashboard" >&lt; Dashboard</a></div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 high-five-title" style='color:#e41515'>Contact Us</div>
        </div>
                  ...
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          ...
                          <?php if ($model->attachment != ''): ?>
                            <p><b>Attachement:</b>
                                <img src='http://injoy.injoychange.com/uploads/tickets/<?= $model->attachment ?>' />
                            </p>
                          <?php else: ?>
          ...
          <div class="row contact-us">
              <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <div class="form-group">
                      <?= Html::submitButton('Submit', ['id' => 'contact-button', 'class' => 'btn btn-warning dashboard', 'name' => 'contact-button',style=>'background:'.$color]); ?>
                  </div>
                  <?php ActiveForm::end(); ?>
              </div>
          </div>

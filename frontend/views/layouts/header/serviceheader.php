...
$model_scorepoints = '\frontend\\models\\PilotFrontServiceTotalPoints';
...
$new_notifs = PilotFrontServiceNotifications::find()->where(['user_id' => Yii::$app->user->identity->id, 'notif_status' => 1])->all();
        ...
        <div class=container>
            <div class=row>
                ...
                <?php if (in_array("10", $feature_array)): ?>
                    <div class="col-md-offset-5 col-md-3 col-md-offset-5 col-sm-offset-4 col-sm-4  col-sm-offset-5 col-xs-8 right-info">
                    <?php else: ?>
                            ...
                            <nav class="navbar navbar-inverse">
                                ...
                                <div id=collapse class="collapse navbar-collapse navbar-left">
                                    <ul class="nav navbar-nav">
                                        <li><a href="<?= $baseurl; ?>/service/how-it-work">how it works</a></li>
                                        <li><a data-toggle="modal" href="#rules-prizes">Contest Rules/Prizes</a></li>
                                        <li><a href="<?= $baseurl; ?>/service/tech-support">Tech Support</a></li>
                                        <li><a href="smartphone" data-toggle="modal" data-modal-id="smartphone">SmartPhone</a></li>
                                        <li><a href="<?= $baseurl; ?>/service/leaderboard">Leaderboard</a></li>
                                    </ul>
                                </div>
                            </nav>
                            <?php if (!empty($notifs_bell)): ?>

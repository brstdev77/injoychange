...
$new_notifs = PilotFrontLeadershipNotifications::find()->where(['user_id' => Yii::$app->user->identity->id, 'notif_status' => 1])->all();
                                    ...
                                    <li><?php
                                        ...
                                        <li> 
                                            <div class="points-images" id="star_integrity">
                                                <a href="#" data-toggle="tooltip1" title="A new star will turn gold after each week that you have achieved a perfect score." style="float:right;">
                            ...
                            <nav class="navbar navbar-inverse">
                                ...
                                <div id=collapse class="collapse navbar-collapse navbar-left">
                                    <ul class="nav navbar-nav">
                                        <li><a href="<?= $baseurl; ?>/leadership/how-it-work">how it works</a></li>
                                        <li><a data-toggle="modal" href="#rules-prizes">Contest Rules/Prizes</a></li>
                                        <li><a href="<?= $baseurl; ?>/leadership/tech-support">Tech Support</a></li>
                                        <li><a href="smartphone" data-toggle="modal" data-modal-id="smartphone">SmartPhone</a></li>
                                        <li><a href="<?= $baseurl; ?>/leadership/leaderboard">Leaderboard</a></li>
                                    </ul>
                                </div>
                            </nav>
    <?php if (!empty($notifs_bell)): ?>
                                <div class="notification bell">
                                    <a href='javascript:void(0)'><img class=notification src="<?= $baseurl; ?>/images/notificationleader.png" alt=notification height=32 width=32 /></a>
                                </div>

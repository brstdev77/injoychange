...
if ($action == 'team') {
  $image = 'notificationteam';
}
elseif ($action == 'core') {
  $image = 'notification';
}
elseif ($action == 'leadership') {
  $image = 'notificationleader';
}
elseif ($action == 'service') {
  $image = 'notification';
}
elseif ($action == 'productivity') {
  $image = 'notificationproductivity';
}
else {
  $image = 'notification';
}
...
<header>
    ...
    <?php
    if ($action == 'signup' || $action == 'login' || $action == 'index') {
              ...
              <div class=row>
                  <div class=col-md-12>
                      ...
                      <div class=notification>
                          <a href='#'><img class=notification src="<?= $baseurl; ?>/images/<?= $image; ?>.png" alt=notification height=32 width=32 /></a>
                      </div>
                  </div></div></div>
      </div>
      <?php

...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <?php if($_SESSION['company_id'] == '96' || $_SESSION['company_id'] == '94'){?>
            <link rel="apple-touch-icon" href="/images/iphone_icon_knox.png" />
        <?php } elseif(Yii::$app->user->identity->company_id == '106'){?>
            <link rel="apple-touch-icon" href="/images/iphone_icon_toyota.png" />
        <?php }else{?>
            <link rel="apple-touch-icon" href="/images/iphone_icon.jpg" />
        <?php } ?>
...
");
?>
    <body class="Leadsdashboard"> 
        <?php $this->beginBody() ?>

        <div class="wrap">

            <?= $this->render('header/leadsheader.php', ['baseUrl' => $baseUrl]) ?>
            <div class="container">
        ...
        <?= $this->render('footer/leadsfooter.php', ['baseUrl' => $baseUrl]) ?>

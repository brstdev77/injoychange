...
$this->title = 'Dashboard | Intentional Leadership';
$baseurl = Yii::$app->request->baseurl;
$game = \frontend\models\PilotFrontUser::getGameID('intentionalleadership');
$user_id = Yii::$app->user->identity->id;
$comp_id = Yii::$app->user->identity->company_id;
$challenge_id = \frontend\models\PilotFrontUser::getGameID('intentionalleadership');
...
if (empty($audio_entry_weekly)):
    ...
    $first_lock_img = 'leadership_unlock.png';
    $sec_lock_img = 'leadership_lock.png';
    $third_lock_img = 'leadership_lock.png';
...
if (!empty($audio_entry_first)):
    if (empty($audio_entry_currentday)):
        ...
        $third_li_cls = 'disable';
        $first_lock_img = 'leadership_unlock.png';
        $sec_lock_img = 'leadership_unlock.png';
        $third_lock_img = 'leadership_lock.png';
        $first_modal_link = 'audio-modal?tip=first';
...
if (!empty($audio_entry_sec)):
    if (empty($audio_entry_currentday)):
        ...
        $third_li_cls = 'enable';
        $sec_lock_img = 'leadership_lock.png';
        $third_lock_img = 'leadership_unlock.png';
        $sec_modal_link = 'audio-modal?tip=second';
...
if (empty($know_entry_weekly)):
    ...
    $first_lock_img_know = 'leadership_unlock.png';
    $sec_lock_img_know = 'leadership_lock.png';
...
if (!empty($know_entry_first)):
    if (empty($know_entry_currentday)):
        ...
        $first_lock_img_know = 'leadership_unlock.png';
        $sec_lock_img_know = 'leadership_unlock.png';
        $first_modal_link_know = 'know-modal?tip=first';
            ...
            <div class="col-md-4 col-sm-4 outer_left">
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/intentionalleadership/daily-inspiration">View All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                ...
                <div class="today_g">
                    ...
                    <div class="content" style="background:#fff;">
                        <div class="tool">
                            <img width="158" height="344" alt="week" src="../images/leadership_know.png" class="video">
                        </div>
                    ...
                    <div class="bg-color">
                        <div class="value">
                            ...
                            <div id="today_values">
                                ...
                                <a class="" href="<?= $baseurl; ?>/intentionalleadership/toolbox">View All&nbsp;<span><i class="fa fa-angle-right"></i></span></a>
                            </div> 
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-color">
                        ...
                        <div class=place>
                            ...
                            <div class=addmore-seeall>
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/intentionalleadership/high-five">View All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                                ...
                                <div class='highfivecomment'>
                                    <?php if (count($all_highfives) == 0): ?>
                                        ...
                                        foreach ($all_highfives as $hghfv):
                                            ...
                                            $check_comment_liked = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                            ...
                                            $total_likes = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                            //Total Comments
                                            $total_comments = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                            //Time
                                            $created = $hghfv->created;
                                            $cmnt_time = date('M d, Y h:i A', $created);

                                            //Comment Image
                                            $comment_image = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                            ?>
                                                ...
                                                <div class=count>
                                                    ...
                                                    if (!empty($comment_option)):
                                                        ...
                                                        <div class=comment_count>
                                                            <img src="../images/msg.png" alt="message"><span> (<span class="c_count <?= $hghfv->id; ?>" style="color:#545454"><?= count($total_comments); ?></span>)<a href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $hghfv->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment" style="color:#545454"> Add Comment</a></span>
                                                        </div>
                                                    <?php endif; ?>

...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/intentionalleadership/dashboard" >&lt; Dashboard</a></div>
                  ...
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          ...
                          <?php if ($model->attachment != ''): ?>
                            <p><b>Attachement:</b>
                                <img src='http://injoychange.com/uploads/tickets/<?= $model->attachment ?>' />
                            </p>
                          <?php else: ?>

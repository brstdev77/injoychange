...
$value = Yii::$app->request->get('PilotFrontIntentionalleadershipHighfiveSearch');
...
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title" style="padding-bottom: 0"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/intentionalleadership/dashboard">&lt; Dashboard</a></div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 high-five-title">SHOUT OUTS & DIGITAL HIGH FIVES</div>
                ...
                <div class="pilot-front-highfive-search">
                    ...
                    <div class='tt-scrollable-menu'>
                        <div class="form-group">
                            <input id="project" class='form-control tt-hint' name='PilotFrontIntentionalleadershipHighfiveSearch[user_id]' placeholder='Search for teammate' value='<?= $name ?>'>
                    ...
                    <div class="table_1"   >
                        ...
                        echo ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $index, $widget) use ($count) {
                                ...
                                $check_comment_liked = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->one();
                                ...
                                $total_likes = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $model->id])->all();
                                //Total Comments
                                $total_comments = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $model->id])->all();
                                //Comment Image
                                $comment_image = PilotFrontIntentionalleadershipHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $model->id])->all();
                                ?>
                                    ...
                                    <div class="points-data record-tr <?= $cls ?>">
                                        ...
                                        <div class="count highfive">
                                            ...
                                            <div class=comment_count>
                                                <img src="../images/msg.png" alt="message"><span> (<span class="c_count <?= $model->id; ?>"><?= count($total_comments); ?></span>)<a onclick="saveusercomment(this, event)" href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $model->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment"> Add Comment</a></span>
                                            </div>
                                        </div>

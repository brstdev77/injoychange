...
<?php if (isset($daily_model)): ?>
    ...
    <div class = "modal-footer">
        ...
        <?php if (empty($daily_entry)): ?>
            <?= Html::Button('Submit 20 pts', ['class' => 'sub-btn btn btn-warning text-capitalize save-daily', 'style' => 'float:left;']); ?>
        <?php endif; ?> 
...
<?php if (isset($know_model)): ?>
    ...
    <div class="modal-body">
        <div class = "container-fluid" style = "text-align: center;">
            ...
            ?>
            <div class="modal-image">
                <div class="tip_des" style="text-align:center;"><?= $didyouknow_tip_obj->description; ?></div>
            </div>
        </div>
    </div>
    <div class = "modal-footer">
    ...
    <div class="modal-body">
        ...
        <div class="container-fluid" style="text-align: center;">
            <div class="weekly_audio">
                ...
                ?>
                <div class="col-xs-12 col-md-4 audio_image2" style="padding:0">
                    ...
                    if (!empty($lesson)):
                        ...
                        <div class="col-md-12" style="padding:0;text-align:left">
                            ...
                            $form->field($audio_model, 'correct_id')->radioList(ArrayHelper::map(PilotTodayslessonQuestion::find()->where(['corner_id' => $leadership_tip_obj->id])->all(), 'id', function ($element) {
                                        return strip_tags($element['answer']);
                                    }))->label(false);
                            //$form->field($audio_model, 'correct_id')->checkboxList($c)->label(false);
                            ?>
                            <img src="" class="help-block1" />

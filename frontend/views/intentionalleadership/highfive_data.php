...
$j=1;
 if (count($all_highfivecomment) == 0): ?>
                                        ...
                                        foreach ($all_highfivecomment as $hghfv):
                                            ...
                                            $check_comment_liked = PilotFrontIntentionalleadershipHighfive::find()->where(['feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                            ...
                                            $total_likes = PilotFrontIntentionalleadershipHighfive::find()->where(['feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                            //Total Comments
                                            $total_comments = PilotFrontIntentionalleadershipHighfive::find()->where(['feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                            //Time
                                            ...
                                            $comment_image = PilotFrontIntentionalleadershipHighfive::find()->where(['feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                            ?>
                                                ...
                                                <div class=count>
                                                    ...
                                                    if (!empty($comment_option)):
                                                        ...
                                                        <div class=comment_count>
                                                            <img src="../images/msg.png" alt="message"><span> (<span class="c_count <?= $hghfv->id; ?>"><?= count($total_comments); ?></span>)<a onclick="saveusercomment(this,event)" href="highfive-usercomment-modal?uid=<?= $user_id; ?>&cid=<?= $hghfv->id; ?>" data-toggle="modal" data-modal-id="highfive-usercomment"> Add Comment</a></span>
                                                        </div>
                                                    <?php endif; ?>

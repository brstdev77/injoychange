...
$this->title = 'Leaderboard | LANDCARE CUSTOMER SERVICE';
    ...
    <div class="content main-dashboard-banners">
                                ...
                                <div class="top-performer-banner-elevation">
                                    <div class="leaderboard-elevation-number">
                                        <div class="elevating-count">
                                            ...
                                            <div class="top-performer-elevation-title">Total LandCare Actions</div>
                                        </div>
        ...
        <div class=row>
            <div class="dashboard-title leaderboard-title">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/customer/dashboard">&lt; Dashboard</a></div>   
            </div>
        </div>
        <div class=row>
            <?php

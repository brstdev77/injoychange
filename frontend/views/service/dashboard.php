...
$dayset = date('Y-m-d');
$ratesaved = PilotFrontServiceRating::find()->where(['user_id' => $user_id, 'dayset' => $dayset, 'company_id' => $comp_id])->one();
if ($userImage == ''):
...
if (in_array(11, $feature_array)):
    ...
    $query = PilotFrontServiceHighfive::find()->where(['not in', 'id', $subQuery])->andWhere(['challenge_id' => $game_id])->andWhere(['=', 'feature_label', 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
    $count = $query->count();
    if ($count > 20) {
        $limit = 0;
    } else {
    ...
    $count = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveComment'])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC])->count();
    if ($count > 20) {
        $limit = 0;
    } else {
        $limit = 1;
...
$subQuery1 = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage'])->select('linked_feature_id');
$query1 = PilotFrontServiceHighfive::find()->where(['in', 'id', $subQuery1])->andWhere(['=', 'feature_label', 'highfiveComment'])->andWhere(['week_no' => $week_no])->andWhere(['user_id' => $user_id])->orderBy(['created' => SORT_DESC, 'id' => SORT_DESC]);
        ...
        <div class=row>
            <div class=col-md-12>
                <div class=main-dashboard-banner>
                    ...
                    <?php } else { ?>
                        <img class=main-banner src="<?= $baseurl; ?>/images/banner_service.png" alt=banner height=392 width=1180 />
                    <?php } ?>
                </div>
            </div>
        </div>
                    ...
                    <div class=s_daily_ins>
                        <div class="bg-color bg-img">
                            ...
                            <div class=submitinspiration>
                                ...
                                <div class="see_more">
                                    <span class="see-al"><a href="<?= $baseurl; ?>/service/daily-inspiration">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                                </div>
                ...
                <div class=s_checkin>
                    <div class=bg-color>
                        <h1 class="heading new">
                            ...
                            <span class="icon_right" href="smartphone" data-toggle="modal" data-modal-id="smartphone"><img src="<?= $baseurl; ?>/images/smartphn.png" alt="" height=26 width=16></span>
                        </h1>
                        <div class=value>
                            <div class=value_content>
                                <div class=activecontent>
                                    ...
                                    if (!empty($game_obj->core_heading)) {
                                        $word = $game_obj->core_heading;
                                        $coreHeading = strtoupper($word);
                                    } else {
                                ...
                                <?php if (empty($prev_today_values_currentday)): ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="checkin-seeall <?= $rating; ?>">
                                            ...
                                            ?>
                                            <a href="<?= $baseurl; ?>/service/checkin" class="">See All&nbsp;<span><i class="fa fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div id="today_values">
                        ...
                        <div class="place <?=$place;?>">
                            ...
                            if (!empty($image_upload_shout)):
                                ...
                                <?php if (in_array(11, $feature_array)): ?>
                                    <div class="upload_hf_image upload_image">
                            ...
                            if (in_array(11, $feature_array)):
                                ?>
                                <div class="btn-group sht_btn dashboard_button">
                                    <input type='hidden' name='imageuploaded' id='imageuploaded' value='0' />
                                    <input type='hidden' name='shoutout' id='shoutout' value='0' />
                                    <button type="button" class="btn btn-primary shoutoutsgiven appreciation1 shout0" data-tabname="icac" rel="0">APPRECIATION</button>
                                    <button type="button" class="btn btn-primary shoutoutsgiven highfiveimage shout1" data-tabname="region" style="color:rgb(46, 109, 164);background:#fff" rel="1"><?= $button;?></button>
                                </div>
                            <?php endif; ?>
                            <input type="hidden" value="<?= $enable_upload; ?>" id="upload_image_feature"/>
                            <div class="addmore-seeall <?= $see_all;?>"> 
                                <a class="squaredbutton1 right" href="<?= $baseurl; ?>/service/high-five">See All <span><i class="fa fa-angle-right"></i></span></a>
                            </div>
                            <?php
                            if (!empty($image_upload_shout)):
                                if (in_array(11, $feature_array)):
                                        ...
                                        <div class="highfivecomment">
                                            <?php if (count($all_highfives) == 0): ?>
                                                ...
                                                foreach ($all_highfives as $hghfv):
                                                    ...
                                                    $check_comment_liked = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'user_id' => $user_id, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->one();
                                                    ...
                                                    $total_likes = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveLike', 'linked_feature_id' => $hghfv->id])->all();
                                                    //Total Comments
                                                    $total_comments = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveUserComment', 'linked_feature_id' => $hghfv->id])->all();
                                                    //Time
                                                    $created = $hghfv->created;
                                                    $cmnt_time = date('M d, Y h:i A', $created);

                                                    //Comment Image
                                                    $comment_image = PilotFrontServiceHighfive::find()->where(['game_id' => $game, 'company_id' => $comp_id, 'feature_label' => 'highfiveCommentImage', 'linked_feature_id' => $hghfv->id])->all();
                                                    ?>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=toolbox-lc-right>
                                ...
                                <?php elseif ($game_obj->left_corner_type == '1'): ?>
                                    <ul>
                                        <li class="<?= $first_li_cls; ?>">
                                            <div class="li-text">
                                                <?php if (!empty($first_modal_link) && $first_modal_link != 'javascript:void(0)'): ?>
                            ...
                            <div class=submitleader>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/service/toolbox">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=submitweek style='position: relative'>
                                ...
                                <span class="see-al"><a href="<?= $baseurl; ?>/service/weekly">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=today_g>
                        ...
                        <div class=content>
                            ...
                            <div class=align-center>
                                ...
                                <span class=see-al><a href="<?= $baseurl; ?>/service/share-a-win">See All <span><i class="fa fa-angle-right"></i></span></a></span>
                            </div>
                        </div>
                    </div>
                </div>

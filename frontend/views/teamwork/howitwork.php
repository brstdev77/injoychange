...
$this->title = 'How it Work | Teamwork';
$baseurl = Yii::$app->request->baseurl;
?>
<?php $this->registerCssFile($baseurl . '/css/seeall.css'); ?>
<div class="site-index">
    <div class="seeall-data">
        <div class="dashboard-title"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 dashboard-link"><a class="btn btn-warning dashboard" href="<?= $baseurl; ?>/teamwork/dashboard">&lt; Dashboard</a></div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 high-five-title">How it work</div>
        </div>
        <div class="work_content">
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkdaily.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                    <h3>Daily Inspiration</h3>
                    <ul>
                        <li><h4>These are quick daily thoughts of inspiration that will motivate you to excel through this challenge. The daily inspirations relate to the core values and will remind you of their importance. Our attitude is so largely impacted by thought. Even one positive message read in the morning can set the tone for the whole day.</h4></li>
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkcheck.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkpoint.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                    <h3>your Points</h3>
                    <ul>
                        ...
                        <li><h4> Everything you do on this site earns you points. Those points will earn you the chance at some amazing prizes and bragging rights on your team.</h4></li>
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkhive.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkleader.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                    ...
                    <ul>
                        ...
                        <li><h4>The toolbox section will become a library of memorable tools and insights for you to take with you throughout this challenge and beyond. 
                            </h4></li>
                        <li><h4>Points Value = 10 points per day</h4></li>
                    </ul>                           
                </div>
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data odd">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkweek.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 points-data even">               
                <div class=" col-lg-4 col-md-6 col-sm-6 col-xs-12 left-images">
                    <p style="text-align: center"><img class=main-banner src="<?= $baseurl; ?>/images/howitwork/teamworkshare.png" /></p>
                </div>                     
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 right-data">
                    <h3>share a win</h3>
                    <ul>

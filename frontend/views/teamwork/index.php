...
<img class=main-banner src="<?= $baseurl; ?>/images/bannerteam.png" alt=banner height=392 width=1180 />
</div>
</div>
</div>
...
<div class="home_page_text">
    ...
    <h1 class="rtecenter"><strong> Welcome to the 30 - Day Teamwork Challenge!</strong></h1>
...
<ul class="">
    ...
    else
    {
        ?>
    <ul>
            <li><a href="<?= $baseurl; ?>/teamwork/dashboard" class=name_user>Dashboard</a> </li>
